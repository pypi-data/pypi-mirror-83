...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '3.4.0-alpha.1603707140+8b117943'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 3.4.0-alpha.1603707140+8b117943`
                """)
