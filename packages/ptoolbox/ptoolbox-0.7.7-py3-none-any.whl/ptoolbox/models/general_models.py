...
class Problem:
    def __init__(self):
        self.src_id = ""
        self.translations: List[Problem] = {}
        self.src_url = ""
        self.src_name = ""
        self.src_status_url = ""
        self.src_data = None
        ...
        self.languages = []
        self.solutions = []  # list of solution for each language: [{'lang': '11.cpp', 'code': "..."}]
...
class Classroom:
    ...
    def __str__(self):
        ...
        s += "\nNo of scheduled_assignments: " + str(len(self.scheduled_assignments))
        s += "\nNo of draft_assignments: " + str(len(self.draft_assignments))
