...
class McPlayerAlreadyRegisteredError(McdbotError):
    NAME = "You have a different Minecraft player already registered: "
...
class BadMcPlayerError(McdbotError):
    NAME = "Incorrect Minecraft player name. (Is more than 16 characters or has an illegal character - " \
