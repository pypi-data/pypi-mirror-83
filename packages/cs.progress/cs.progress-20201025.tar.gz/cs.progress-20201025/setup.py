...
setup(
 ...
 'statusfunc=None, width=None, report_print=None, insert_pos=1, '    
 'deferred=False)`\n'    
 '\n'    
 ...
 'itemlenfunc=None, statusfunc=None, incfirst=False, width=None, '    
 ...
 'Initial release of cs.progress.'),
  ...
  install_requires = ['cs.deco', 'cs.logutils', 'cspy.func', 'cs.seq', 'cs.units', 'cs.upd'],
