...
class StackInstanceService(object):
    ...
    def __init__(self, infrastructure_target=None, provisioning_parameters=None, cloud_provider='generic', secrets=None, hosts=None, resources=None, agent='', opa_outputs=None, outputs=None, packages=None, tags=None, local_vars_configuration=None):  # noqa: E501
