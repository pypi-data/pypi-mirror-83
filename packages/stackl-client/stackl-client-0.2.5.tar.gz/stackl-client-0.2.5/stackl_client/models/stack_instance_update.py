...
class StackInstanceUpdate(object):
    ...
    def __init__(self, params=None, service_params=None, stack_instance_name='default_test_instance', secrets=None, tags=None, replicas=None, disable_invocation=False, local_vars_configuration=None):  # noqa: E501
