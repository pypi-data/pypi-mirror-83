...
class Party:
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            self.connection.initialize(self.router, self.agg_info, None, token)
    ...
    def register_party(self):
        ...
        try:
            ...
            if response.get_data()['status'] == 'success':
                ...
                self.extract_model_from_stream(data)
    ...
    def extract_model_from_stream(self, data):
        ...
        model_config_agg = data.get('model_config')
...
if __name__ == '__main__':
    ...
    p = Party(config_file=args.config_file, token=args.token)
    if (args.interactive):
