    ...
    def store(self, meta_props, background_mode=True):
        ...
        if ('compute' in meta_props or 'storage' in meta_props) and self._client.ICP_PLATFORM_SPACES:
            raise WMLClientError("'STORAGE' and 'COMPUTE' meta props are not applicable on "
                                 "Cloud Pak for Data. If using any of these, remove and retry")
    ...
    def get_id(spaces_details):
        """
            ...
            **Example**
             ...
             >>> space_uid = client.spaces.get_id(space_details)
        """

        PlatformSpaces._validate_type(spaces_details, u'spaces_details', object, True)
