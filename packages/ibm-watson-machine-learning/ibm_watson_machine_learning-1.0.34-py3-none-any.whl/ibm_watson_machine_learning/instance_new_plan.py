...
class ServiceInstanceNewPlan:
    ...
    def get_username(self):
        """
             Get username for your Watson Machine Learning service. Applicable only for Cloud Pak for Data
    ...
    def get_password(self):
        """
             Get password for your Watson Machine Learning service. Applicable only for Cloud Pak for Data
