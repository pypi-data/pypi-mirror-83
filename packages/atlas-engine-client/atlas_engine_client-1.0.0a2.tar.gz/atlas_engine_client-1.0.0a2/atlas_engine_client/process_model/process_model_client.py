...
import asyncio
from atlas_engine_client import process_model
import logging 
...
class ProcessModelClient(base_client.BaseClient):

    def __init__(self, url, session=None, identity=None):
        super(ProcessModelClient, self).__init__(url, session, identity)
