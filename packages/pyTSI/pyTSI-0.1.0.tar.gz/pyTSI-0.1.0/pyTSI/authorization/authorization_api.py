...
class AuthorizationApi:
    ...
    def get_token(self):
        ...
        try:
            ...
            if status_code == 401:
                logging.error(
                    "pyTSI: Authentication with the TSI api was unsuccessful. Check your client secret."
                )
            else:
                logging.error(
                    "pyTSI: The request to the TSI api returned an unsuccessfull status code. Check the stack trace"
                )
            raise
