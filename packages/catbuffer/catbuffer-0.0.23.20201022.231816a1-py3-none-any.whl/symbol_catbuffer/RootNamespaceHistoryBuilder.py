...
class RootNamespaceHistoryBuilder:
    ...
    def __init__(self, id: NamespaceIdDto, ownerAddress: AddressDto, lifetime: NamespaceLifetimeBuilder, rootAlias: NamespaceAliasTypeDto, paths: List[NamespacePathBuilder]):
        """Constructor.
        Args:
            id: Id of the root namespace history.
            ownerAddress: Namespace owner address.
    ...
    def loadFromBinary(cls, payload: bytes) -> RootNamespaceHistoryBuilder:
        ...
        rootAlias = NamespaceAliasTypeDto.loadFromBinary(bytes_)  # kind:CUSTOM2
        ...
        return RootNamespaceHistoryBuilder(id, ownerAddress, lifetime, rootAlias, paths)
    ...
    def getRootAlias(self) -> NamespaceAliasTypeDto:
