...
class InflationReceiptBuilder(ReceiptBuilder):
    ...
    def __init__(self, size: int, version: int, type: ReceiptTypeDto, mosaic: MosaicBuilder):
        """Constructor.
        Args:
            size: Entity size.
    ...
    def loadFromBinary(cls, payload: bytes) -> InflationReceiptBuilder:
        ...
        return InflationReceiptBuilder(superObject.size, superObject.version, superObject.type, mosaic)
