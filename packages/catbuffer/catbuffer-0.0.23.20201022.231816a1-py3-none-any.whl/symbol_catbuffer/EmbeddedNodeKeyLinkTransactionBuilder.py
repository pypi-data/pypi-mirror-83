...
class EmbeddedNodeKeyLinkTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedNodeKeyLinkTransactionBuilder:
        ...
        return EmbeddedNodeKeyLinkTransactionBuilder(superObject.size, superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, nodeKeyLinkTransactionBody.linkedPublicKey, nodeKeyLinkTransactionBody.linkAction)
