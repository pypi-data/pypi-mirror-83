...
class BlockHeaderBuilder:
    ...
    def loadFromBinary(cls, payload: bytes) -> BlockHeaderBuilder:
        ...
        bytes_ = bytes_[4:]
        return BlockHeaderBuilder(size, signature, signerPublicKey, version, network, type, height, timestamp, difficulty, generationHashProof, previousBlockHash, transactionsHash, receiptsHash, stateHash, beneficiaryAddress, feeMultiplier)
