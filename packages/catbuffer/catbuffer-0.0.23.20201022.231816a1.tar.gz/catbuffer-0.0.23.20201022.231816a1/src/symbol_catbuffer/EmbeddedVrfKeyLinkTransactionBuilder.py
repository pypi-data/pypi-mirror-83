...
class EmbeddedVrfKeyLinkTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedVrfKeyLinkTransactionBuilder:
        ...
        return EmbeddedVrfKeyLinkTransactionBuilder(superObject.size, superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, vrfKeyLinkTransactionBody.linkedPublicKey, vrfKeyLinkTransactionBody.linkAction)
