...
class AccountAddressRestrictionTransactionBodyBuilder:
    ...
    def __init__(self, restrictionFlags: List[AccountRestrictionFlagsDto], restrictionAdditions: List[UnresolvedAddressDto], restrictionDeletions: List[UnresolvedAddressDto]):
        """Constructor.
        Args:
            restrictionFlags: Account restriction flags.
            restrictionAdditions: Account restriction additions.
    ...
    def loadFromBinary(cls, payload: bytes) -> AccountAddressRestrictionTransactionBodyBuilder:
        ...
        bytes_ = bytes_[4:]
        restrictionAdditions: List[UnresolvedAddressDto] = []  # kind:ARRAY
        ...
        restrictionDeletions: List[UnresolvedAddressDto] = []  # kind:ARRAY
