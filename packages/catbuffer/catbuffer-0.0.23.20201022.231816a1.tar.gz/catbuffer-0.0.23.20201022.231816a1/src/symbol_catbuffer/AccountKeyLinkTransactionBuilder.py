...
class AccountKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    def loadFromBinary(cls, payload: bytes) -> AccountKeyLinkTransactionBuilder:
        ...
        return AccountKeyLinkTransactionBuilder(superObject.size, superObject.signature, superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, superObject.fee, superObject.deadline, accountKeyLinkTransactionBody.linkedPublicKey, accountKeyLinkTransactionBody.linkAction)
