...
class NamespaceMetadataTransactionBodyBuilder:
    ...
    def __init__(self, targetAddress: UnresolvedAddressDto, scopedMetadataKey: int, targetNamespaceId: NamespaceIdDto, valueSizeDelta: int, value: bytes):
        """Constructor.
        Args:
            targetAddress: Metadata target address.
            scopedMetadataKey: Metadata key scoped to source, target and type.
    ...
    def loadFromBinary(cls, payload: bytes) -> NamespaceMetadataTransactionBodyBuilder:
        ...
        return NamespaceMetadataTransactionBodyBuilder(targetAddress, scopedMetadataKey, targetNamespaceId, valueSizeDelta, value)
