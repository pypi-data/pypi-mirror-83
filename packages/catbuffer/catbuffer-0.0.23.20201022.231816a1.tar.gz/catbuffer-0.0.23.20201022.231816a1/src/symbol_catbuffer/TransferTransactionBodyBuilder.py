...
class TransferTransactionBodyBuilder:
    ...
    Attributes:
        ...
        transferTransactionBody_Reserved2: Reserved padding to align mosaics on 8-byte boundary.
    ...
    def __init__(self, recipientAddress: UnresolvedAddressDto, mosaics: List[UnresolvedMosaicBuilder], message: bytes):
        ...
        self.transferTransactionBody_Reserved2 = 0
    ...
    def getTransferTransactionBody_Reserved2(self) -> int:
        """Gets reserved padding to align mosaics on 8-byte boundary.
        Returns:
            Reserved padding to align mosaics on 8-byte boundary.
        """
        return self.transferTransactionBody_Reserved2
    ...
    def serialize(self) -> bytes:
        ...
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, GeneratorUtils.uintToBuffer(self.getTransferTransactionBody_Reserved2(), 1))  # kind:SIMPLE
        for _ in self.mosaics:
