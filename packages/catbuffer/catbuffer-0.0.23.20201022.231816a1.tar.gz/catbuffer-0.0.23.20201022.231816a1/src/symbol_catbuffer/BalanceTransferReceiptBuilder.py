...
class BalanceTransferReceiptBuilder(ReceiptBuilder):
    ...
    def __init__(self, size: int, version: int, type: ReceiptTypeDto, mosaic: MosaicBuilder, senderAddress: AddressDto, recipientAddress: AddressDto):
        """Constructor.
        Args:
            size: Entity size.
    ...
    def loadFromBinary(cls, payload: bytes) -> BalanceTransferReceiptBuilder:
        ...
        return BalanceTransferReceiptBuilder(superObject.size, superObject.version, superObject.type, mosaic, senderAddress, recipientAddress)
