...
def tensor_to_pyqubo(
    ...
    ind_value_list = [int(index_values[ind]) if isinstance(ind, str) else int(to_pyqubo(ind, placeholder=placeholder, index_values=index_values, fixed_variables=fixed_variables))
