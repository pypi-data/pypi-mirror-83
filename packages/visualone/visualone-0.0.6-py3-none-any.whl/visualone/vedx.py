...
class client():
    ...
    def train(self, path_to_positive_samples, path_to_negative_samples, confidence_threshold, n_pos = -1, n_neg = -1):
        ...
        negative_samples = glob.glob(path_to_negative_samples + "/*.jpg") + glob.glob(path_to_negative_samples + "/*.png") + glob.glob(path_to_negative_samples + "/*.JPG") + glob.glob(path_to_negative_samples + "/*.PNG") + glob.glob(path_to_negative_samples + "/*.JPEG") + glob.glob(path_to_negative_samples + "/*.bmt")
