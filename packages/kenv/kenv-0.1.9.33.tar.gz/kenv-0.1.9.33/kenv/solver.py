...
class Simulation:
    ...
    def track(self,
        ...
        if particle == True:
            ...
            psi = self.particle_armor_angle = particle_trajectory[4,:]
            ...
            self.particle_armor_angle = interpolate.interp1d(self.accelerator.parameter, self.particle_armor_angle, kind='cubic', fill_value=(0, 0), bounds_error=False)
