...
class Game(dict):
    ...
    def __init__(self, **kwargs):
        ...
        self.primary_key = PrimaryKey(name="team_id")

        gsi_primary_key = PrimaryKey(name="game_date")
        self.global_secondary_indexes = [
            DbIndex(name="date", primary_key=gsi_primary_key)
        ]
...
class Odd(dict):
    ...
    def __init__(self, **kwargs):
        if kwargs:
            ...
            self.odd_values: List[OddValues] = [
                OddValues(**o) for o in kwargs.get("odd_values", None)
            ]
            dict.__init__(self, **self.__dict__)
