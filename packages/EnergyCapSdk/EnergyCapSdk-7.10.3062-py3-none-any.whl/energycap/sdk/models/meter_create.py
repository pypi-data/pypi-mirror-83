...
class MeterCreate(Model):
    ...
    def __init__(self, meter_code, meter_info, commodity_id, place_id, address, meter_type_id, bill_entry_note=None, include_in_energy_star=None, properties=None, primary_use_id=None, meter_time_zone_id=None, use_unit_id=None, demand_unit_id=None):
