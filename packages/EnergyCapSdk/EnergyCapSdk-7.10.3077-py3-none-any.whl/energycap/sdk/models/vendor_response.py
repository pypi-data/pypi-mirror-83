...
class VendorResponse(Model):
    ...
    def __init__(self, vendor_id=None, vendor_code=None, vendor_info=None, address=None, edi_code=None, pay_days=None, created_by=None, created_date=None, modified_by=None, modified_date=None, website=None, rates=None):
