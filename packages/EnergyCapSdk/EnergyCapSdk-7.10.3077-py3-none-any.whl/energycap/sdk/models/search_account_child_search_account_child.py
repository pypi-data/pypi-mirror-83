...
class SearchAccountChildSearchAccountChild(Model):
    ...
    def __init__(self, account_code, account_info, account_id=None, active=None, account_type=None, vendor=None, address=None, parent_path=None, has_calculated_meter=None, has_split_parent_meter=None, has_split_child_meter=None):
