...
class Config:
    def __init__(self, config: Dict):
        ...
        self.visualization: Union[Visualization, None] = Visualization(config.get("visualization", {})) if config.get(
            "visualization"
        ) else None
...
class Visualization:
    def __init__(self, visualization: Dict):
        ...
        self.calculated_time_series = self.visualization.get("calculatedTimeSeries", {})
        self.calculated_time_series_tags = self.calculated_time_series.get("tags", [])

    def to_dict(self):
        convert = {
            "timeSeries": {"fields": self.time_series_field_ids},
            "thresholds": {"fields": self.thresholds_field_ids},
            "calculatedTimeSeries": {"tags": self.calculated_time_series_tags},
        }
        return convert
