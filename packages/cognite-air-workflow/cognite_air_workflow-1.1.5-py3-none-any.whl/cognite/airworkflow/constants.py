...
if Project.NAME.value in url_dict:
    PROJECT_TO_API_KEYS = {
        Project.NAME: ProjectInfo(Project.NAME, "AIR_DEPLOY_API_KEY", "AIR_API_KEY", str(url_dict[Project.NAME.value]))
    }
else:
    PROJECT_TO_API_KEYS = {Project.NAME: ProjectInfo(Project.NAME, "AIR_DEPLOY_API_KEY", "AIR_API_KEY")}
