...
async def monitoring_loop(prtg_api: PRTGHTTPApi, sensors: list, snmp_eng: SnmpEngine, run_monitoring: bool):
        ...
        if tasks_api_response.status_code == 200:
            ...
            if len(tasks) > 0:
                await monitoring.monitoring(
                    tasks_list=tasks, sensor_objects=sensors, snmp_engine=snmp_eng, prtg_api=prtg_api
                )
