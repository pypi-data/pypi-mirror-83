...
from picta_dl.extractor import get_info_extractor

RETRIES = 3


class YoutubeDL(picta_dl.YoutubeDL):
...
def generator(test_case, tname):
    ...
    def test_template(self):
        ie = picta_dl.extractor.get_info_extractor(test_case['name'])()
