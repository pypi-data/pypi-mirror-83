/*! For license information please see chunk.aa4a6cc2b9885f28a865.js.LICENSE.txt */
(self.webpackJsonp=self.webpackJsonp||[]).push([[136],{141:function(t,e,i){"use strict";i(47),i(79);var o=i(6),n=i(3),s=i(4),r=i(5);Object(o.a)({_template:s.a`
    <style>
      :host {
        @apply --layout-inline;
...
`,is:"iron-icon",properties:{icon:{type:String},theme:{type:String},src:{type:String},_meta:{value:r.a.create("iron-meta",{type:"iconset"})}},observers:["_updateIcon(_meta, isAttached)","_updateIcon(theme, isAttached)","_srcChanged(src, isAttached)","_iconChanged(icon, isAttached)"],_DEFAULT_ICONSET:"icons",_iconChanged:function(t){var e=(t||"").split(":");this._iconName=e.pop(),this._iconsetName=e.pop()||this._DEFAULT_ICONSET,this._updateIcon()},_srcChanged:function(t){this._updateIcon()},_usesIconset:function(){return this.icon||!this.src},_updateIcon:function(){this._usesIconset()?(this._img&&this._img.parentNode&&Object(n.a)(this.root).removeChild(this._img),""===this._iconName?this._iconset&&this._iconset.removeIcon(this):this._iconsetName&&this._meta&&(this._iconset=this._meta.byKey(this._iconsetName),this._iconset?(this._iconset.applyIcon(this,this._iconName,this.theme),this.unlisten(window,"iron-iconset-added","_updateIcon")):this.listen(window,"iron-iconset-added","_updateIcon"))):(this._iconset&&this._iconset.removeIcon(this),this._img||(this._img=document.createElement("img"),this._img.style.width="100%",this._img.style.height="100%",this._img.draggable=!1),this._img.src=this.src,Object(n.a)(this.root).appendChild(this._img))}})},186:function(t,e,i){"use strict";i(5),i(47),i(57),i(142);var o=i(6),n=i(4),s=i(102);Object(o.a)({_template:n.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[s.a]})},266:function(t,e,i){"use strict";i(5),i(47);var o=i(6),n=i(3),s=i(4),r=i(165);Object(o.a)({_template:s.a`
    <style>
      :host {
        display: block;
        /**
