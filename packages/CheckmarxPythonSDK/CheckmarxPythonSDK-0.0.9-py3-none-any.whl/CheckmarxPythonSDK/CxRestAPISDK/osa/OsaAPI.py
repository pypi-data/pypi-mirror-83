...
class OsaAPI(object):
    ...
    def get_all_osa_scan_details_for_project(self, project_id=None, page=1, items_per_page=100):
        ...
        osa_scans_url = config.get("base_url") + "/osa/scans?projectId=" + str(project_id)
    ...
    def get_osa_scan_by_scan_id(self, scan_id):
        ...
        osa_scan_by_scan_id_url = config.get("base_url") + "/osa/scans/{scanId}".format(scanId=scan_id)
    ...
    def get_all_osa_file_extensions(self):
        ...
        osa_file_extensions_url = config.get("base_url") + "/osa/fileextensions"
    ...
    def get_osa_licenses_by_id(self, scan_id):
        ...
        osa_licenses_url = config.get("base_url") + "/osa/licenses" + "?scanId=" + str(scan_id)
    ...
    def get_osa_scan_libraries(self, scan_id, page=1, items_per_page=100):
        ...
        osa_libraries_url = config.get("base_url") + "/osa/libraries" + "?scanId=" + str(scan_id)
    ...
    def get_osa_scan_vulnerabilities_by_id(self, scan_id, page=1, items_per_page=100, library_id=None,
        ...
        osa_vulnerabilities_url = config.get("base_url") + "/osa/vulnerabilities"
    ...
    def get_osa_scan_vulnerability_comments_by_id(self, vulnerability_id, project_id):
        ...
        osa_vulnerability_comment_url = config.get("base_url") + "/osa/vulnerabilities/{vulnerabilityId}/comments".format(
    ...
    def get_osa_scan_summary_report(self, scan_id):
        ...
        osa_reports_url = config.get("base_url") + "/osa/reports" + "?scanId=" + str(scan_id)
