...
class ProjectsAPI(object):
    ...
    def get_all_project_details(self, project_name=None, team_id=None):
        ...
        projects_url = config.get("base_url") + "/projects"
    ...
    def get_project_details_by_id(self, project_id):
        ...
        project_url = config.get("base_url") + "/projects/{id}".format(id=project_id)
    ...
    def create_branched_project(self, project_id, branched_project_name):
        ...
        project_branch_url = config.get("base_url") + "/projects/{id}/branch".format(id=project_id)
    ...
    def get_all_issue_tracking_systems(self):
        ...
        issue_tracking_systems_url = config.get("base_url") + "/issueTrackingSystems"
    ...
    def get_issue_tracking_system_details_by_id(self, issue_tracking_system_id):
        ...
        issue_tracking_systems_metadata_url = config.get("base_url") + "/issueTrackingSystems/{id}/metadata".format(
    ...
    def get_project_exclude_settings_by_project_id(self, project_id):
        ...
        exclude_settings_url = config.get("base_url") + "/projects/{id}/sourceCode/excludeSettings".format(id=project_id)
    ...
    def get_remote_source_settings_for_git_by_project_id(self, project_id):
        ...
        remote_settings_git_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/git".format(id=project_id)
    ...
    def get_remote_source_settings_for_svn_by_project_id(self, project_id):
        ...
        remote_settings_svn_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/svn".format(id=project_id)
    ...
    def get_remote_source_settings_for_tfs_by_project_id(self, project_id):
        ...
        remote_settings_tfs_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/tfs".format(id=project_id)
    ...
    def get_remote_source_settings_for_custom_by_project_id(self, project_id):
        ...
        remote_settings_custom_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/custom".format(
            id=project_id
        )
    ...
    def get_remote_source_settings_for_shared_by_project_id(self, project_id):
        ...
        remote_settings_shared_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/shared".format(
            id=project_id
        )
    ...
    def get_remote_source_settings_for_perforce_by_project_id(self, project_id):
        ...
        remote_settings_perforce_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/perforce".format(
            id=project_id
        )
    ...
    def set_remote_source_setting_to_git_using_ssh(self, project_id, url, branch, private_key_file_path):
        ...
        remote_settings_git_ssh_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/git/ssh".format(
            id=project_id
        )
    ...
    def set_remote_source_setting_to_svn_using_ssh(self, project_id, absolute_url, port, paths, private_key_file_path):
        ...
        remote_settings_svn_ssh_url = config.get("base_url") + "/projects/{id}/sourceCode/remoteSettings/svn/ssh".format(
            id=project_id
        )
    ...
    def upload_source_code_zip_file(self, project_id, zip_file_path):
        ...
        attachments_url = config.get("base_url") + "/projects/{id}/sourceCode/attachments".format(id=project_id)
    ...
    def set_data_retention_settings_by_project_id(self, project_id, scans_to_keep=10):
        ...
        data_retention_settings_url = config.get("base_url") + "/projects/{id}/dataRetentionSettings".format(id=project_id)
    ...
    def set_issue_tracking_system_as_jira_by_id(self, project_id, issue_tracking_system_id, jira_project_id,
        ...
        jira_url = config.get("base_url") + "/projects/{id}/issueTrackingSettings/jira".format(id=project_id)
    ...
    def get_all_preset_details(self):
        ...
        presets_url = config.get("base_url") + "/sast/presets"
    ...
    def get_preset_details_by_preset_id(self, preset_id):
        ...
        preset_url = config.get("base_url") + "/sast/presets/{id}".format(id=preset_id)
