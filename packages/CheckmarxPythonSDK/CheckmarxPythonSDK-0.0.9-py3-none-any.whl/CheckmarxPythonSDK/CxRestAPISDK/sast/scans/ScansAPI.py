...
class ScansAPI(object):
    ...
    def get_all_scans_for_project(self, project_id=None, scan_status=None, last=None):
        ...
        all_scans_url = config.get("base_url") + "/sast/scans"
    ...
    def get_sast_scan_details_by_scan_id(self, scan_id):
        ...
        sast_scan_url = config.get("base_url") + "/sast/scans/{id}".format(id=scan_id)
    ...
    def get_statistics_results_by_scan_id(self, scan_id):
        ...
        statistics_results_url = config.get("base_url") + "/sast/scans/{id}/resultsStatistics".format(id=scan_id)
    ...
    def get_scan_queue_details_by_scan_id(self, scan_id):
        ...
        scans_queue_url = config.get("base_url") + "/sast/scansQueue/{id}".format(id=scan_id)
    ...
    def get_all_scan_details_in_queue(self, project_id=None):
        ...
        all_scan_queue_url = config.get("base_url") + "/sast/scansQueue"
    ...
    def get_scan_settings_by_project_id(self, project_id):
        ...
        scan_settings_url = config.get("base_url") + "/sast/scanSettings/{projectId}".format(projectId=project_id)
    ...
    def define_sast_scan_settings(self, project_id, preset_id, engine_configuration_id=1, post_scan_action_id=None,
        ...
        all_scan_settings_url = config.get("base_url") + "/sast/scanSettings"
    ...
    def define_sast_scan_scheduling_settings(self, project_id, schedule_type, schedule_days, schedule_time):
        ...
        schedule_settings_url = config.get("base_url") + "/sast/project/{projectId}/scheduling".format(projectId=project_id)
    ...
    def assign_ticket_to_scan_results(self, results_id, ticket_id):
        ...
        scan_results_ticket_url = config.get("base_url") + "/sast/results/tickets"
    ...
    def publish_last_scan_results_to_management_and_orchestration_by_project_id(self, project_id):
        ...
        policy_findings_url = config.get("base_url") + "/sast/projects/{id}/publisher/policyFindings".format(id=project_id)
    ...
    def get_the_publish_last_scan_results_to_management_and_orchestration_status(self, project_id):
        ...
        policy_findings_status_url = config.get("base_url") + "/sast/projects/{id}/publisher/policyFindings/status".format(
            id=project_id
        )
    ...
    def get_short_vulnerability_description_for_a_scan_result(self, scan_id, path_id):
        ...
        url = config.get("base_url") + "/sast/scans/{id}/results/{pathId}/shortDescription".format(id=scan_id, pathId=path_id)
    ...
    def register_scan_report(self, scan_id, report_type):
        ...
        register_scan_report_url = config.get("base_url") + "/reports/sastScan"
    ...
    def get_report_status_by_id(self, report_id):
        ...
        report_status_url = config.get("base_url") + "/reports/sastScan/{id}/status".format(id=report_id)
    ...
    def get_report_by_id(self, report_id):
        ...
        report_url = config.get("base_url") + "/reports/sastScan/{id}".format(id=report_id)
