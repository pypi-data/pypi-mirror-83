...
class DataRetentionAPI(object):
    ...
    def stop_data_retention(self):
        ...
        stop_data_retention_url = config.get("base_url") + "/sast/dataRetention/stop"
    ...
    def define_data_retention_date_range(self, start_date, end_date, duration_limit_in_hours):
        ...
        define_data_retention_date_range_url = config.get("base_url") + "/sast/dataRetention/byDateRange"
    ...
    def define_data_retention_by_number_of_scans(self, number_of_successful_scans_to_preserve, duration_limit_in_hours):
        ...
        define_data_retention_number_of_scans_url = config.get("base_url") + "/sast/dataRetention/byNumberOfScans"
    ...
    def get_data_retention_request_status(self, request_id):
        ...
        data_retention_request_status_url = config.get("base_url") + "/sast/dataRetention/{requestId}/status".format(
