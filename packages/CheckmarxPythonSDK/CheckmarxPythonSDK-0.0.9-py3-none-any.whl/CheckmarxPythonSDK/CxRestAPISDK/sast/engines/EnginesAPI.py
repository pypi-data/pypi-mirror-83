...
class EnginesAPI(object):
    ...
    def get_all_engine_server_details(self):
        ...
        engine_servers_url = config.get("base_url") + "/sast/engineServers"
    ...
    def unregister_engine_by_engine_id(self, engine_id):
        ...
        engine_server_url = config.get("base_url") + "/sast/engineServers/{id}".format(id=engine_id)
    ...
    def get_all_engine_configurations(self):
        ...
        engine_configurations_url = config.get("base_url") + "/sast/engineConfigurations"
    ...
    def get_engine_configuration_by_id(self, configuration_id):
        ...
        engine_configuration_url = config.get("base_url") + "/sast/engineConfigurations/{id}".format(id=configuration_id)
