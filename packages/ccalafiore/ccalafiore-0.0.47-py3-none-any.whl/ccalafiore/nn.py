...
class Loader:
    ...
    def __init__(
        ...
        # print('self.time.range =', self.time.range)
...
def train_early_stop(model, loader, criterion, optimizer, scheduler, I=10):
...
def train_early_stop_old(model, loader, criterion, optimizer, scheduler, I=10):
