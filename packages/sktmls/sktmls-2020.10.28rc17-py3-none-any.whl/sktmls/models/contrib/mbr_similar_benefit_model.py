...
class MbrSimilarBenefitModel(MLSRuleModel):
    ...
    def predict(self, x: List[Any], **kwargs) -> Dict[str, Any]:
        ...
        print("env", os.getenv("AWS_ENV"))
        print(self.pf_client.config.MLS_PROFILE_API_URL)
        ...
        print("use_benefit", use_benefit)
        print("like_benefit", like_benefit)
        ...
        print("available_benefit", available_benefit)
        ...
        print("source", source_act, source_benefit_id)
        ...
        print("source_brand", source_brand)
        print("target_benefit_list", target_benefit_list)
        ...
        print("valid_target_benefit_list", valid_target_benefit_list)
