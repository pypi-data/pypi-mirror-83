    ...
    def configure (self, *args, **kwargs):
        ...
        for c in commands:
            ...
            if "commit" in c:
                ...
                #linux.LinuxDevice.cmd(self, "show | compare rollback 1 | no-more", **kwargs)
    ...
    def x_set_policy (self,
        ...
        if isinstance(dynamic_application, list):
            for dynapp in dynamic_application:
                self.configure(common_part +  "match application %s" %(dynapp))
        elif dynamic_application:
            self.configure(common_part +  "match application %s" %(dynamic_application))
