...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.24.0-alpha.1603901555+09c71ac5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.24.0-alpha.1603901555+09c71ac5`
                """)
            else:
                raise
