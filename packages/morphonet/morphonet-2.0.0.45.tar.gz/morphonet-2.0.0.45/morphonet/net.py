        ...
        if self._ownDataSet():
            ...
            if 'status' in data2: 
                ...
                if texture is not None and material is not None:
                    data=self._large_request({"uploadlargetexture":self.id_dataset,"t":t,"id_mesh":ids,"quality":quality,"channel":channel,"type":ttype,"material":material},'/api/uploadtextureapi/',texture)
                    data2 = json.loads(data)
                    id_texture = -1
                    if 'status' in data2: 
