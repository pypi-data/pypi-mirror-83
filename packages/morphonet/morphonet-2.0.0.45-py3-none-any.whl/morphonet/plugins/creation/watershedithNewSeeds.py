    ...
    def process(self,t,dataset,objects): #PLUGIN EXECUTION
        ...
        for s in seeds:
            ...
            if _centerInShape(seed,data.shape):
                ...
                print(" ----> this seed "+str(seed)+ " is out of the image")
        ...
        for new_id in new_ids:
            ...
            if len(newIdCoord[0])>min_vol:
                ...
                print(" ----> add object "+str(nbc+cMax)+' with  '+str(len(newIdCoord[0]))+ " voxels")
                dataset.set_seg(t,data)
                nbc+=1
            else:
                print(" ----> remove object with  "+str(len(newIdCoord[0]))+ " voxels")
        print(" --> Found  "+str(nbc)+" new labels")
        self.restart()
