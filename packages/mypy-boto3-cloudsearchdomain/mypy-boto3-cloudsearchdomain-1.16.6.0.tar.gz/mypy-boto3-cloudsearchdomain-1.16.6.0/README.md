...
[boto3.CloudSearchDomain 1.16.6](https://boto3.amazonaws.com/v1/documentation/api/1.16.6/reference/services/cloudsearchdomain.html#CloudSearchDomain) service
compatible with
