...
from .utils import selector_utils, service_utils


@service_utils.regenerate_credentials
def authenticate(
...
def get_authenticated(
    ...
    cred_files = [file for file in files if file.startswith("client_secret")]

    if len(cred_files) == 1:
        client_config = cred_files[0] + ".json"
