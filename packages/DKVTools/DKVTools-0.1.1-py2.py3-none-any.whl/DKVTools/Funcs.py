...
def pyData2LuaLines( data, key=None, deepth=0, indent='    ', lines=None, clearNil=True, strMarks='\'' ) :
    ...
    if isinstance(data, dict) :
        ...
        for k,v in list(data.items()) :
            pyData2LuaLines(v, k, deepth+1, indent, lines, clearNil, strMarks)
        append('%s},'%(_indent))
        ...
        append('%s{'%(_indent))
        for v in data :
            pyData2LuaLines(v, None, deepth+1, indent, lines, clearNil, strMarks)
        append('%s},'%(_indent))
