...
class CloudAssemblyBuilder(
    ...
    def add_missing(
        ...
        *,
        key: builtins.str,
        props: typing.Union[_AmiContextQuery_a528fa4a, _AvailabilityZonesContextQuery_a84904c8, _HostedZoneContextQuery_3a794037, _SSMParameterContextQuery_6f44d3dd, _VpcContextQuery_12233b2e, _EndpointServiceAvailabilityZonesContextQuery_9b9d87e5],
