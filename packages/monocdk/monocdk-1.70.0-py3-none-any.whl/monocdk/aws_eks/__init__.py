...
class KubectlLayer(
    ...
    def add_permission(
        ...
        *,
        ...
        :param organization_id: (experimental) The ID of the AWS Organization to hwich the grant is restricted. Can only be specified if ``accountId`` is ``'*'``
...
class Cluster(
    ...
    def open_id_connect_provider(self) -> _OpenIdConnectProvider_de671fa1:
