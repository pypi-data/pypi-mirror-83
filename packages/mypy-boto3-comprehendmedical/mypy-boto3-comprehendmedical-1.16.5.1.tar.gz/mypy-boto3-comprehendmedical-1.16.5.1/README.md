...
[boto3.ComprehendMedical 1.16.5](https://boto3.amazonaws.com/v1/documentation/api/1.16.5/reference/services/comprehendmedical.html#ComprehendMedical) service
compatible with
