...
- Fixed french translations, replace translation `donneur` by `emetteur` everywhere.
...
- Simplified french translation "${number_of_annexes} annexe(s) a(ont) ete stockee(s)." to "${number_of_annexes} annexes ont ete stockees.".
