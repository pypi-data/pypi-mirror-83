...
[boto3.PinpointSMSVoice 1.16.2](https://boto3.amazonaws.com/v1/documentation/api/1.16.2/reference/services/pinpoint-sms-voice.html#PinpointSMSVoice) service
compatible with
