...
def train_multimodel(configini):
    ...
    def LearningCurve(features, targetFrame, shuffle_splits, dataset_splits,savefileno):
        ...
        fname = os.path.join(ensemble_evaluations_out, str(classifierName) + '_' + str(saveFileNo) + '_learning_curve.csv')
