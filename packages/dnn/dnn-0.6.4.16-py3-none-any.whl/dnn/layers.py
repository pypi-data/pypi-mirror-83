...
class Layers:
    ...
    def embedding (self, n_input, size_voca, size_embed, mask_zero = True):
        return tf.keras.layers.Embedding (input_dim = size_voca, output_dim = size_embed, mask_zero = mask_zero) (n_input)
    ...
    def _rnn_impl  (self, cell, n_input, units, activation = 'tanh', return_sequences = True, return_state = False, time_major = False, dropout = 0.0, kreg = None, stateful = False):
