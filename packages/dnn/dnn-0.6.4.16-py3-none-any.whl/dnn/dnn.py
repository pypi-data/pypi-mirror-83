...
class BaseDNN:
    ...
    def embeddings_v1 (self, n_input, size_voca, size_embed, dropout = False):
    ...
    def embeddings (self, padded_inputs, size_voca, size_embed, mask_zero = True, dropout = False):
        embed = tf.keras.layers.Embedding (input_dim = size_voca, output_dim = size_embed, mask_zero = mask_zero) (padded_inputs)
        if dropout:
            embed = self.dropout (embed)
        return embed
