...
class Utils:
    ...
    def __get_all2all(self,task_path):
    ...
    def get_weigh_corr(self,task_path,force_refresh=False):
        ...
        save_path = os.path.join(task_path, '{}_weigh.ckpt'.format('SANN'))
        ...
        cur_weigh, debug_weigh = self.__get_all2all(task_path)
        corr = self.get_corr(task_path,cur_weigh)
    ...
    def get_corr(self,task_path,cur_weigh,force_refresh=False):
    ...
    def get_xy_cross_val(self,task_path,k,force_refresh=False):
        ...
        def get_xy_split(test_index):
            ...
            weigh,weigh_Debug = self.__get_all2all(task_path)
            corr = self.get_corr(task_path)
