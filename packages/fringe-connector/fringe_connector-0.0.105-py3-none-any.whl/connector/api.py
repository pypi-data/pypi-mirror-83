...
class GMail():
    ...
    def fetchEmails(self, searchTerm, userId='me', subject=None, label=None, hasAttachment=False, maxResults=None, pageToken=None, includeSpamTrash=False, getAttachments=False):
            ...
            if getAttachments and hasParts:
                ...
                for part in msg_raw['payload']['parts']:
                    if part['filename']:
                        ...
                        filename = f"downloads/{emailId['id']}_{part['filename']}"
