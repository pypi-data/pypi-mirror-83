...
Ready to contribute? Here's how to set up `ynabintegrationscli` for local development.
Using of pipenv is highly recommended.

1. Clone your fork locally::

    $ git clone https://github.com/costastf/ynabintegrationscli
