...
from pywappalyzer.scraper import (
    get_html,
...
def mock_write_json(mocker):
    mock_write_json = mocker.patch("pywappalyzer.scraper.write_json")
...
def test_write_json(mock_write_json):
...
def test_scrape_technologies_to_json(mock_write_json, mock_requests):
