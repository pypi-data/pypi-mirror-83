define([
    ...
    , 'nbextensions/visualpython/src/numpy/api/NumpyCommonApi'

], function ( requirejs, $, vpCommon, vpConst, sb, vpFuncJS, 
              vpNumpyConst, numpyStateApi, numpyRouteMapApi, NumpyCommonApi ) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
        , funcName : "numpyCorrelation"
        , funcID : "JY210"  // TODO: ID 규칙 생성 필요
    }

    // FuncId에 맞는 FuncData를 맵핑하는 api
    var { newMapFuncIdToNumpyFuncData, mapFuncIdToHtmlUrlPath } = numpyRouteMapApi;
