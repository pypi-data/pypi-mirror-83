define([
    ...
    var initOption = function(callback) {
        vpCommon.loadHtml(vpCommon.wrapSelector(vpConst.OPTION_GREEN_ROOM), "pandas/common/commonPandas.html", optionLoadCallback, callback);
    }
    ...
    PandasPackage.prototype.bindOptions = function() {
        ...
        $(this.wrapSelector('#vp_inputOutputBox table')).prepend(
            $('<tr>').append($('<td><label for="fileType">* 파일 유형</label></td>'))
                .append($('<td><select id="fileType"></select></td>'))
        );
     ...
     */
    PandasPackage.prototype.generateCode = function(exec) {
