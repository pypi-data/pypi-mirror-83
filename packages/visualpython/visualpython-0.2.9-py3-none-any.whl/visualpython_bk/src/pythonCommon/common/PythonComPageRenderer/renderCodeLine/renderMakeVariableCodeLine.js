define ([
    ...
    var { bindCodeLineEventFunc, mapCodeLineDataToStr } = helperFunc;
    var renderMakeVariableCodeLine = function(pythonComPageRendererThis, index) {
        ...
        var data = codeLineArray[index].data ? mapCodeLineDataToStr(codeLineArray[index].data) : ``;
        var defBlock = $(`<div class="vp-pythonCom-line vp-pythonCom-line-${index + 1} vp-pythonCom-style-flex-row-between">
                            ...
                            <div class="vp-pythonCom-style-flex-row">
                                <div class="vp-pythonCom-style-flex-column-center"
                                    style="white-space: break-spaces; ">Line ${index + 1} : ${currIndentSpaceStr}</div>
                                <div class="vp-pythonCom-style-flex-column-center scrollbar"
                                    style="  margin-right:5px;white-space: break-spaces; text-overflow: ellipsis; overflow: auto;"> ${data} </div>
                            </div>
    ...
    return renderMakeVariableCodeLine;
