define ([
     ...
     * @constructor
    */
    var PythonComCommentCodeValidator = function() {
    ...
    */
    PythonComCommentCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);
    ...
    */
    // FIXME: 임시로 true
    PythonComCommentCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComCommentCodeValidator;
});