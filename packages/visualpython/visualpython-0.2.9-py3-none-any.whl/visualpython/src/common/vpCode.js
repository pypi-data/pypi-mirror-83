define([
    ...
    var _apiStack =  {
        ...
        11: { code: "'Age'", type: 'code', metadata: { funcID: 'com_udf', prefix: [], postfix: [], options: [ { id: 'vp_userCode', value: "'Age of Ultron'"} ] } }
    }
    var _apiHead = 0;
    ...
    VpCode.prototype.loadContainer = function(parentContainer = this.parentContainer) {
        ...
        droppableEle.contextmenu(function(event) {
            ...
            if (event.target.className.includes('vp-ma-container')) {
                $('.vp-ma-popup').css({left: event.offsetX + 30, top: event.offsetY + 150})
                $('.vp-ma-popup').show();
                return false;
            }
        });
