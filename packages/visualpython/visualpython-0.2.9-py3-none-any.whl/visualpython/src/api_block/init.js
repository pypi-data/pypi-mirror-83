define([
    ...
    //     , findStateValue
    //     , mapTypeToName } = api;
    const {BLOCK_CODE_BTN_TYPE } = constData;
    ...
    var init = function(){
        ...
        new CreateBlockBtn(blockContainer, BLOCK_CODE_BTN_TYPE.CODE);
        createBlockBtnArray.forEach(enumData => {
            if (enumData === BLOCK_CODE_BTN_TYPE.API || enumData === BLOCK_CODE_BTN_TYPE.CODE) {
                return;
            }
