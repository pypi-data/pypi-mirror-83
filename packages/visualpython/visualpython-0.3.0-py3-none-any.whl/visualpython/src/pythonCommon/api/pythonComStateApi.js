define ([
    ...
    /** addOneArrayIndexValueAndGetNewArray
     *  배열의 특정 인덱스 다음에 새로운 데이터를 추가하고  새로운 배열을 리턴한다
     *  @param {Array} array 
     *  @param {number} index
     *  @param {any} newValue 
     *  @returns {Array} New array
     */
    var addOneArrayIndexValueAndGetNewArray = function(array, index, newValue) {
    ...
    var fixParameterValue = function(parameterStr) {
