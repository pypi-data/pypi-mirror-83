define ([
    ...
    var renderReturnCodeLine = function(pythonComPageRendererThis, index) {
        ...
        var dataStr = codeLineArray[index].data 
                        ? mapCodeLineDataToStr(codeLineArray[index].data)
                        : "";
        var block= $(`<div class="vp-pythonCom-line vp-pythonCom-line-${index + 1} vp-pythonCom-style-flex-row-between">
                            ...
                            <div class="vp-pythonCom-style-flex-row">
                                ...
                                <strong class="vp-pythonCom-style-flex-column-center"
                                    style="margin-right:5px;">return </strong>
                                <span class="vp-pythonCom-style-flex-column-center"
                                    style="margin-right:5px;"> ${dataStr} </span>
                            </div>
