define ([
    ...
    var renderReturnPaletteBlock = function(pythonComPageRendererThis, type) {
        ...
        /** 
         * PaletteBlock이 렌더링 되었는데, type이 RETURN 타입이면 데이터를 함께 렌더링한다
         */
        ...
        var { paletteContainer: tokenContainer, 
            ...
            = pythonComPageRendererThis._renderSelectCodeLineTokenBlockAndConfirmButton(`Edit RETURN Line : ${currLineIndex + 1}`,uuid);
        pythonComCodeLinePageRenderer.setGenerateCodeButton(tokenConfirmButton, currLineIndex + 1);

        var subPaletteView = $(`<div class="vp-pythonCom-subPalette-return-view-body"></div>`);
        ...
        pythonComCodeLinePageRenderer.pageRender(`.vp-pythonCom-subPalette-return-view-body`, "Generate Return문");
    ...
    return renderReturnPaletteBlock;
});
