define ([
     ...
     * @constructor
    */
    var PythonComPrintCodeValidator = function() {
    ...
    */
    PythonComPrintCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);
    ...
    */
    // FIXME: 임시로 true
    PythonComPrintCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComPrintCodeValidator;
});
