define ([
     ...
     * @constructor
    */
    var PythonComMakeListCodeValidator = function() {
    ...
    */
    PythonComMakeListCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);
    ...
    */
    // FIXME: 임시로 true
    PythonComMakeListCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComMakeListCodeValidator;
});
