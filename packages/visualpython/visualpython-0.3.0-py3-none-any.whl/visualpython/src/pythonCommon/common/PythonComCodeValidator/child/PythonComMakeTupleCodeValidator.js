define ([
     ...
     * @constructor
    */
    var PythonComMakeTupleCodeValidator = function() {
    ...
    */
    PythonComMakeTupleCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);
    ...
    */
    // FIXME: 임시로 true
    PythonComMakeTupleCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComMakeTupleCodeValidator;
});
