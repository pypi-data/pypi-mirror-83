define([
    ...
    vpAccordionBox.prototype.toTagString = function() {
        ...
        sbTagString.appendFormatLine("<div class='{0} {1} {2} {3}' {4}>"
            , that._componentID, vpConst.ACCORDION_CONTAINER, that._isOpen ? "accordion-open" : "", that._uniqueness ? "uniqueType" : "", that._attributes ? that._attributes : "");
        ...
        sbTagString.appendFormatLine("<div class='{0}{1}'>{2}</div>", vpConst.VP_CLASS_PREFIX, "accordion-content", that._contents);
