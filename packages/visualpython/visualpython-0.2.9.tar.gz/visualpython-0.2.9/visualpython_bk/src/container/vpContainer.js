define([
    ...
    var apiBlockPageInit = function() {
        ...
        // api block wrap 영역
        sbApiBlockPage.appendFormatLine("<div id='{0}'></div>", vpConst.API_BLOCK_CONTAINER);
     ...
     */
    var apiBlockLoadCallback = function() {
     ...
     */
    var addLibraryToJupyterCell = function(run, callback) {
        // TODO: valitate
    ...
    $(document).on("click", vpCommon.wrapSelector(vpCommon.formatString("#{0}", vpConst.OPTION_BTN_SAVE_ON_NOTE)), function() {
        addLibraryToJupyterCell(false, addNoteNode);
        openNoteArea();
    });
        /**
     * 노트 노드 추가
