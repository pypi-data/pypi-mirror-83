define ([
    ...
    var renderClassCodeLine = function(pythonComPageRendererThis, index)  {
        ...
        var classData = codeLineArray[index].data && codeLineArray[index].data.name 
                            ? codeLineArray[index].data.name 
                            : "";
        var classParamList= codeLineArray[index].data && codeLineArray[index].data.paramList 
                            ? mapDefParamListToStr("CLASS",codeLineArray[index].data.paramList)
                            : "";
        var block = $(`<div class="vp-pythonCom-line vp-pythonCom-line-${index + 1} vp-pythonCom-style-flex-row-between">
                            ...
                            <div class="vp-pythonCom-style-flex-row">
                                ...
                                <strong class="vp-pythonCom-style-flex-column-center"
                                        style="margin-right:5px;">class </strong>
                                <span class="vp-pythonCom-style-flex-column-center"
                                      style="margin-right:5px;"
                                      data-caption-id="${classData}"> ${classData} </span>
                                <span class="vp-pythonCom-style-flex-column-center"
                                      style="margin-right:5px;"
                                      data-caption-id="${classParamList}"> ${classParamList} </span>
                                <span class="vp-pythonCom-style-flex-column-center"
