...
define ([
    ...
    var renderCodeLinePaletteBlock = function(pythonComPageRendererThis, type) {
        ...
        /** 
         * PaletteBlock이 렌더링 되었는데, type이 CUSTOM_CODE_LINE 타입이면 데이터를 함께 렌더링한다
         */
        ...
        var { paletteContainer: tokenContainer, 
            ...
            = pythonComPageRendererThis._renderSelectCodeLineTokenBlockAndConfirmButton(`Edit Code Line ${currLineIndex + 1}`,uuid);
        ...
        /** Python Common Code Line 패키지 렌더링 */
        pythonComCodeLinePageRenderer.setImportPackageThis(importPackageThis);
        pythonComCodeLinePageRenderer.pageRender(`.vp-pythonCom-subPalette-view-body`);
    ...
    return renderCodeLinePaletteBlock;
});