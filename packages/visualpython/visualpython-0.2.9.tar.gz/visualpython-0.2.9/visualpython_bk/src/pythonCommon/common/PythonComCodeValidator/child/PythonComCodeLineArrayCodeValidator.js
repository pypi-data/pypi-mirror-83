define ([
     ...
     * @constructor
    */
    var PythonComCodeLineArrayCodeValidator = function() {
    ...
    */
    PythonComCodeLineArrayCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);

    /**
     * PythonComCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    PythonComCodeLineArrayCodeValidator.prototype.validate = function() {
        return true;
    }

    return PythonComCodeLineArrayCodeValidator;
});
