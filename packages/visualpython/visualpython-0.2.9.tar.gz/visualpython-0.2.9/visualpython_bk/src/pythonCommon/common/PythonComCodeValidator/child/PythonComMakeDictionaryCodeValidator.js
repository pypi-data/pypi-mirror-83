define ([
     ...
     * @constructor
    */
    var PythonComMakeDictionaryCodeValidator = function() {
    ...
    */
    PythonComMakeDictionaryCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);

    /**
     * PythonComCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    PythonComMakeDictionaryCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComMakeDictionaryCodeValidator;
});
