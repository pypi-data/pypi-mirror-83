define ([
    ...
    var renderSelfVariableCodeLine = function(pythonComPageRendererThis, index) {
        ...
        var data = `self.${codeLineArray[index].data} = ${codeLineArray[index].data}`;
    ...
    return renderSelfVariableCodeLine;
