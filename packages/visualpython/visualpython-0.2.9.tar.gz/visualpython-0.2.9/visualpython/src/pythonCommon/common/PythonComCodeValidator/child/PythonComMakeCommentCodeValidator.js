define ([
     ...
     * @constructor
    */
    var PythonComMakeCommentCodeValidator = function() {
    ...
    */
    PythonComMakeCommentCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);

    /**
     * PythonComCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    PythonComMakeCommentCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComMakeCommentCodeValidator;
});
