...
define ([
    ...
    /** PrintFuncPalleteBlock 동적 렌더링
     * @param { pythonComPageRenderer prototype this} pythonComPageRendererThis  
     */
    var renderPrintFuncPalleteBlock = function(pythonComPageRendererThis, type) {
        ...
        var { paletteContainer, paletteConfirmButton } 
            = pythonComPageRendererThis._renderSelectCodeLineTokenBlockAndConfirmButton(`Print()`,uuid);

        var subPaletteView = $(`<div class="vp-pythonCom-subPalette-print-view-body"></div>`);
        ...
        pythonComCodeLinePageRenderer.pageRender(`.vp-pythonCom-subPalette-print-view-body`);
    ...
    return renderPrintFuncPalleteBlock;
});
