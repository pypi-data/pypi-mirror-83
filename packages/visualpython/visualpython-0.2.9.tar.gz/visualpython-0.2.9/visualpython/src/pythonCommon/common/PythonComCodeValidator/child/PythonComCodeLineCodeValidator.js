define ([
     ...
     * @constructor
    */
    var PythonComCodeLineCodeValidator = function() {
    ...
    */
    PythonComCodeLineCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);

    /**
     * PythonComCodeValidator 클래스의 makeCode 메소드 오버라이드
     * @param {Obejct} state 
    */
    PythonComCodeLineCodeValidator.prototype.validate = function() {
        return true;
    }

    return PythonComCodeLineCodeValidator;
});
