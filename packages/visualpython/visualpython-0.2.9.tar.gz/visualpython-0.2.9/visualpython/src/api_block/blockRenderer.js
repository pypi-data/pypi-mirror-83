define([
    ...
    var renderMainHeaderDom = function(that) {
        ...
        var blockCodeType =  that.getType();
        var blockName = that.getName();
        var isBreakOrContinueOrPass = false;
        if (blockCodeType === BLOCK_CODE_TYPE.BREAK || blockCodeType === BLOCK_CODE_TYPE.CONTINUE || blockCodeType === BLOCK_CODE_TYPE.PASS) {
            isBreakOrContinueOrPass = true;
        }
        ...
        var mainHeaderDom = $(`<div class='vp-block-header'>
                                ...
                                <div class='vp-nodeeditor-codeline-ellipsis 
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.CLASS   
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.IF    
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.FOR   
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.WHILE 
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.ELIF
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.EXCEPT
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.BREAK  
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.CONTINUE  
                                        ...
                                        ${
                                            blockCodeType === BLOCK_CODE_TYPE.CODE  
    ...
    var renderBottomOptionName = function(that, name, blockCodeType, uuid) {
        ...
        if (blockCodeType === BLOCK_CODE_TYPE.CLASS) {
            ...
            if (classNameState === STR_NULL) {
                ...
                classStr += 'vp-nodeeditor-option-input-required';
            }
        ...
        } else if (blockCodeType === BLOCK_CODE_TYPE.BREAK) {
        ...
        } else if (blockCodeType === BLOCK_CODE_TYPE.CONTINUE) {
        ...
        } else if (blockCodeType === BLOCK_CODE_TYPE.PASS) {
        ...
        var inParamContainer = $(`<div class='vp-nodeeditor-ifoption-container'>
                                            <div class='vp-nodeeditor-tab-navigation-node-block-title'>
                                                <span class='vp-block-optiontab-name'>
                                                    in param</span>
                                                <div class='vp-nodeeditor-style-flex-row-center' >
                                                    <span class='vp-nodeeditor-number vp-nodeeditor-style-flex-column-center'
    ...
    var renderDefaultOrDetailButton = function(that, uuid, blockCodeType) {
        ...
        if (blockCodeType === BLOCK_CODE_TYPE.IMPORT) {
