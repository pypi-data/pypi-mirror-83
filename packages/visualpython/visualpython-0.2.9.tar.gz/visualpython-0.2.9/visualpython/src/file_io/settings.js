define([
    ...
    var initOption = function(callback) {
        vpCommon.loadHtml(vpCommon.wrapSelector(vpConst.OPTION_GREEN_ROOM), "file_io/settings.html", optionLoadCallback, callback);
    }
     ...
     */
    SettingPackage.prototype.generateCode = function(exec) {
