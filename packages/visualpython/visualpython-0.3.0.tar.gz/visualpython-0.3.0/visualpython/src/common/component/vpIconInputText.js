define([
    ...
    vpIconInputText.prototype.toTagString = function() {
        ...
        sbTagString.appendFormatLine("<div class='{0} {1}'>", that._componentID, vpConst.ICON_INPUT_TEXT);
    ...
    vpIconInputText.prototype.addEvent = function(events, component, handler) {
        ...
        switch (component.toLowerCase()) {
            case "text":
            case "input":
                $(document).on(events, that.wrapSelector(vpCommon.formatString("{0}", "input")), handler);
                break;
