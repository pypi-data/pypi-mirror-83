define ([
     ...
     * @constructor
    */
    var PythonComMakeSetCodeValidator = function() {
    ...
    */
    PythonComMakeSetCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);
    ...
    */
    // FIXME: 임시로 true
    PythonComMakeSetCodeValidator.prototype.validate = function(state) {
        return true;
    }

    return PythonComMakeSetCodeValidator;
});
