define ([
     ...
     * @constructor
    */
    var PythonComEnumerateCodeValidator = function() {
    ...
    */
    PythonComEnumerateCodeValidator.prototype = Object.create(PythonComCodeValidator.prototype);
    ...
    */
    // FIXME: 임시로 true
    PythonComEnumerateCodeValidator.prototype.validate = function() {
        return true;
    }

    return PythonComEnumerateCodeValidator;
});
