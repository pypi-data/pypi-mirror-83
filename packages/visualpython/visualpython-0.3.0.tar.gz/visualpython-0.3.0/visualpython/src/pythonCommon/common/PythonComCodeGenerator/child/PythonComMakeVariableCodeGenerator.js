define ([
     ...
     * @constructor
    */
    var PythonComMakeVariableCodeGenerator = function() {
        PythonComCodeGenerator.call(this);
    };


    PythonComMakeVariableCodeGenerator.prototype = Object.create(PythonComCodeGenerator.prototype);


    /**
     * PythonComCodeGenerator makeCode 메소드 오버라이드
     */
    PythonComMakeVariableCodeGenerator.prototype.makeCode = function() {
    ...
    */
    ...
    return PythonComMakeVariableCodeGenerator;
});
