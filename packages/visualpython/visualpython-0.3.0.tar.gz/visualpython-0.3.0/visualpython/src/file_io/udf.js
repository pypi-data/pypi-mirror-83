define([
    ...
    , 'nbextensions/visualpython/src/common/vpCode'
    // TEST: CodeMirror
    , 'codemirror/lib/codemirror'
    , 'codemirror/mode/python/python'
    , 'notebook/js/codemirror-ipython'
    , 'codemirror/addon/display/placeholder'
], function (requirejs, $, vpCommon, vpConst, sb, vpFuncJS, vpSetting, VpCode, CodeMirror, cmpython, cmip) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
    ...
    var optionLoadCallback = function(callback) {
        ...
        if (typeof(callback) === 'function') {
            ...
            vpCode = new VpCode(optionPackage);
            vpCode.load();
        }
    }
    ...
    var initOption = function(callback) {
        vpCommon.loadHtml(vpCommon.wrapSelector(vpConst.OPTION_GREEN_ROOM), "file_io/udf.html", optionLoadCallback, callback);
    }
    ...
    OptionPackage.prototype.bindCodeMirror = function() {
        ...
        // hover menu
        $('.CodeMirror-lines').on('mouseover', function(event) {
            // TODO: when mouse over, show add block popup to the end of the .CodeMirror-line div tag
        });
    }
