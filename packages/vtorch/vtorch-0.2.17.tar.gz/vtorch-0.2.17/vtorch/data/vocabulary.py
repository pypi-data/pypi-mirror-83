...
from typing import TYPE_CHECKING, Any, Callable, DefaultDict, Dict, Iterable, List, Optional, Sequence, Set, Union

from ..common.checks import ConfigurationError
from ..common.loading import load_pickle
from ..common.tqdm import Tqdm
from ..common.utils import namespace_match
...
class _NamespaceDependentDefaultDict(DefaultDict[str, Any]):
    """
...
class Vocabulary:
    ...
    def __init__(
        ...
        pretrained_files: Optional[Optional[Dict[str, str]]] = None,
        only_include_pretrained_words: bool = False,
        tokens_to_add: Optional[Dict[str, Sequence[str]]] = None,
        limit_pretrained_embeddings: Optional[Dict[str, int]] = None,
    ) -> None:
        self.padding_token = DEFAULT_PADDING_TOKEN
        self.oov_token = DEFAULT_OOV_TOKEN
        self._non_padded_namespaces = set(non_padded_namespaces)
        self._token_to_index = _TokenToIndexDefaultDict(
            self._non_padded_namespaces, self.padding_token, self.oov_token
        )
    ...
    def _extend(
        ...
        non_padded_namespaces: Iterable[str] = DEFAULT_NON_PADDED_NAMESPACES,
        pretrained_files: Optional[Dict[str, str]] = None,
        only_include_pretrained: bool = False,
        tokens_to_add: Optional[Dict[str, Sequence[str]]] = None,
        limit_pretrained_embeddings: Optional[Dict[str, int]] = None,
    ) -> None:
        """
        ...
        for namespace in counter:
            if namespace in pretrained_files:
                pretrained_list = load_pickle(pretrained_files[namespace])
    ...
    def extend_from_instances(
        ...
        min_count: Optional[Dict[str, int]] = None,
        non_padded_namespaces: Optional[Sequence[str]] = None,
        pretrained_files: Optional[Dict[str, str]] = None,
        ...
        """
        non_padded_namespaces = non_padded_namespaces or DEFAULT_NON_PADDED_NAMESPACES
        pretrained_files = pretrained_files or {}
        ...
        self._extend(
            ...
            non_padded_namespaces=non_padded_namespaces,
            pretrained_files=pretrained_files,
            only_include_pretrained=only_include_pretrained,
            tokens_to_add=tokens_to_add,
