...
class DistillationTrainer(Trainer):
    def __init__(
        ...
        super().__init__(
            ...
            trains_logging=trains_logging,
            trains_task=trains_task,
            trains_additional_params_to_log=trains_additional_params_to_log,
        )
        ...
        if self._callbacks.trains_task is not None:
            self._callbacks.trains_task.add_tags(["distillation"])
