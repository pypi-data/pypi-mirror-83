...
class Client(object):
    ...
    def retrieve(self, name, request, target=None):
        ...
        jreply = self._submit('%s/job/submit/%s?directPath=%r' % (self.url, name, self.directPath), request)
        ...
        job_url = '%s/job/status/%s?directPath=%r' % (self.url, job_id, self.directPath)
