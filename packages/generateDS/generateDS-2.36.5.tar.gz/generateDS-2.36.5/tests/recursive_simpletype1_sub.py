...
class PersonIdTypeTypeSub(supermod.PersonIdTypeType):
    def __init__(self, valueOf_=None, **kwargs_):
        super(PersonIdTypeTypeSub, self).__init__(valueOf_,  **kwargs_)
supermod.PersonIdTypeType.subclass = PersonIdTypeTypeSub
# end class PersonIdTypeTypeSub
