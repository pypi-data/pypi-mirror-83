...
from .utils.dynamo_utils import put_item, delete_item_conditionally
from .utils.dynamo_utils import get_item, query_by_key, \
  query_and_project_by_key_condition, scan_table, query_by_key_min_max
from .utils.dynamo_utils import update_item, update_item_conditionally
...
############## LOGS #########################
def query_most_recent_metric_fetching_log(component_id):
  '''
  ...
  logs_list = query_by_key_min_max(key_condition, LOGS_METRICS_FETCHING_TABLE, False)
