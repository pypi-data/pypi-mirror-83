...
<details>
  ...
  ```python
  insert_anomaly(id, event_type, metric_id, timestamp, value, end_timestamp, cross_correlations,
                 possible_related_anomalies, possible_related_matches, dynamodb, is_dev_env)
  # Example
...
<details>
  <summary>insert_anomaly</summary>
