...
def increment_atomic_counter(counter_type, dynamodb):
  ...
  expression_attribute_values = {':v': decimal.Decimal(1)}
  table_name = ATOMIC_COUNTER_TABLE
  response = db_utils.update_item(key_dict, update_expression, expression_attribute_values, table_name, dynamodb)
