...
class InfoIdsResponseData(object):
    ...
    def __init__(self, binary_ids=None, campaign_ids=None, investigation_names=None):  # noqa: E501
        """InfoIdsResponseData - a model defined in Swagger"""  # noqa: E501

        self._binary_ids = None
        self._campaign_ids = None
        self._investigation_names = None
        ...
        if investigation_names is not None:
            self.investigation_names = investigation_names
    ...
    def investigation_names(self):
        """Gets the investigation_names of this InfoIdsResponseData.  # noqa: E501


        :return: The investigation_names of this InfoIdsResponseData.  # noqa: E501
        :rtype: list[str]
        """
        return self._investigation_names

    @investigation_names.setter
    def investigation_names(self, investigation_names):
        """Sets the investigation_names of this InfoIdsResponseData.


        :param investigation_names: The investigation_names of this InfoIdsResponseData.  # noqa: E501
        :type: list[str]
        """

        self._investigation_names = investigation_names
