...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.9.0-alpha.1603901596+50934f70'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.9.0-alpha.1603901596+50934f70`
                """)
            else:
                raise
