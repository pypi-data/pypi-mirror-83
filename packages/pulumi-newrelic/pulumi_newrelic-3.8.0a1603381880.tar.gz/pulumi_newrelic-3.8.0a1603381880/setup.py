...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.8.0-alpha.1603381880+1d729e66'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.8.0-alpha.1603381880+1d729e66`
                """)
            else:
                raise
