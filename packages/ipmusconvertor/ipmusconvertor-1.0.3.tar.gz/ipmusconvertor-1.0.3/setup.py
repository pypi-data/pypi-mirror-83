...
setup (
    name = "ipmusconvertor",
    description = "Converts a user-uploaded data file from IPUMS and exports the updated dataframe as a zipped csv ",
    version = "1.0.3",
    ...
    entry_points='''
        [console_scripts]
        ipmusconvertor=ipmus_data_convertor_cli.__main__:main
    ''',
    author="Damien Kilgannon",
    long_description=README,
    long_description_content_type="text/markdown",
    license="MIT",
    url="https://github.com/damienkilgannon/ipmus_data_convertor_cli",
