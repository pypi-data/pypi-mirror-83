...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'venafi', '0.0.1-alpha.1603470324+7b0c2375'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource venafi 0.0.1-alpha.1603470324+7b0c2375`
                """)
            else:
                raise
