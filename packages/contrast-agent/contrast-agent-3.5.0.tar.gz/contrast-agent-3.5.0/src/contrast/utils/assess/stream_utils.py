...
class BaseStreamProxy(ObjectProxy):
    ...
    TODO: PYT-917 In the future we may want to instrument write and writelines. This would
        require us to treat the stream more like a propagator than a source because
        trusted data could be written to it.

    TODO: PYT-917 We may eventually need to consider the less common __iter__ method, which
