...
class GitLabracadabraGroup(GitLabracadabraObject, GroupsMixin, LabelsMixin, MembersMixin, MilestonesMixin,
                           VariablesMixin):
    ...
    IGNORED_PARAMS = ['unknown_groups', 'unknown_labels', 'unknown_members', 'unknown_milestones', 'unknown_variables']
