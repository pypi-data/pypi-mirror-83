...
class PipelineSchedulesMixin(object):
    ...
    def _process_pipeline_schedules(self, param_name, param_value, dry_run=False, skip_save=False):
        ...
        for current_pipeline_schedule_description, current_pipeline_schedule \
                in sorted(current_pipeline_schedules.items()):
            if current_pipeline_schedule_description in target_pipeline_schedules:
                ...
                for target_pipeline_schedule_param_name, target_pipeline_schedule_param_value \
                    ...
                    try:
                        current_pipeline_schedule_param_value = \
                            getattr(current_pipeline_schedule, target_pipeline_schedule_param_name)
