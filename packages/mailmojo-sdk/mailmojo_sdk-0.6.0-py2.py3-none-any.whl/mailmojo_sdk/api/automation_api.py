...
class AutomationApi(object):
    ...
    def get_campaign_by_id(self, campaign_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_campaign_by_id(campaign_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_campaign_by_id_with_http_info(self, campaign_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_campaign_by_id_with_http_info(campaign_id, async_req=True)
        >>> result = thread.get()
