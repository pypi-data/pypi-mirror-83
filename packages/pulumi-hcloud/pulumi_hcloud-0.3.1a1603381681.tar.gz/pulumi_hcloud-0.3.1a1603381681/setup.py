...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.3.1-alpha.1603381681+59fba931'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.3.1-alpha.1603381681+59fba931`
                """)
            else:
                raise
