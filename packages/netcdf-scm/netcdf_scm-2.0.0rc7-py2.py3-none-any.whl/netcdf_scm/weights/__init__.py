...
if has_regionmask:
    for ar6_region_abbrev in regionmask.defined_regions.ar6.all.abbrevs:
        region_name = "World|AR6 regions|{}".format(ar6_region_abbrev)
    ...
    **Adding new weights**
    ...
    def get_weights_array_without_area_weighting(self, weights_name):
        ...
        try:
            ...
            try:
                if weights_name.startswith("World|AR6 regions|") and not has_regionmask:
                    raise InvalidWeights(
                        "regionmask is not installed. Run `pip install regionmask`"
                    )
