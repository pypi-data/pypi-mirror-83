...
def train_worker(rank, settings, multilabel):
    ...
    if is_aml_dataset_input(settings):
        train_dataset_wrapper, valid_dataset_wrapper = read_aml_dataset(dataset_id=dataset_id,
    ...
    # Save model
    if master_process:
        write_model(best_model, labels=train_dataset_wrapper.labels, output_dir=output_dir,
