...
import azureml.contrib.automl.dnn.vision.object_detection.writers.score as score_module
...
class TestScoring:
    ...
    def test_transform_in_dataloader_produces_same_result(self):
        ...
        score_module._distill_run_from_experiment = self.offline_run_distill
