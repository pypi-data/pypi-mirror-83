...
class DingtalkChatbot(object):
    ...
    """
    def __init__(self, webhook=None, secret=None, pc_slide=False, fail_notice=False, appkey=None, appsecret=None, path=None, chatid=None):
        """
        机器人初始化
        ...
        self.path = path  #需要发送的文件路径
        self.chatid = chatid  # 群组id,https://wsdebug.dingtalk.com/ 链接查询biz.chat.chooseConversationByCorpId
