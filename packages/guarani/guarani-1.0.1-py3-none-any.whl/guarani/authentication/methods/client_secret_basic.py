from webtools import get_basic_authorization

from guarani.exceptions import InvalidClient
from guarani.mixins import ClientMixin
from guarani.models import Request
