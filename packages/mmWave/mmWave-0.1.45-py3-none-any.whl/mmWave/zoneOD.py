# Zone Occupant Detection and Driver Vital Sign
# for only
# ver:0.0.1
# 2020/02/10
# parsing Vehicle Occupant Detection 3D data 
# hardware:(Batman-301)ZOD IWR6843
...
class ZoneOD:
	...
	def __init__(self,port):
		self.port = port
		print("(jb)Zone Occupancy Detection and Driver Vital Sign")
		print("(jb)For Hardware:IWR6843")
		print("(jb)SW:0.0.1: HW:IWR-1642")
		print("(jb)Firmware: ZOD")
