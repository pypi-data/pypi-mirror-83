...
class PoserToken:
  ...
  E_channels = PToken("channels", True, 'Channels', False)
  ...
  E_setGeomHandlerOffset = PToken("setGeomHandlerOffset", False, 'OrientationSA', False)
  ...
  E_smoothZones = PToken("smoothZones", False, 'ColorSA', False)
  ...
  E_linkWeight = PToken("linkWeight", False, 'LinkWeightSA', False)
  ...
  E_fgColor = PToken("fgColor", False, 'OriginSA', False)
  E_bgColor = PToken("bgColor", False, 'OriginSA', False)
  E_shadowColor = PToken("shadowColor", False, 'OriginSA', False)
  ...
  E_center = PToken("center", False, 'OriginSA', False)
  ...
  E_angles = PToken("angles", False, 'ColorSA', False)
  ...
  E_storageOffset = PToken("storageOffset", False, 'StorageOffsetSA', False)
  ...
  E_KdColor = PToken("KdColor", False, 'ColorSA', False)
  E_KaColor = PToken("KaColor", False, 'ColorSA', False)
  E_KsColor = PToken("KsColor", False, 'ColorSA', False)
  E_ReflectionColor = PToken("ReflectionColor", False, 'ColorSA', False)
  E_TextureColor = PToken("TextureColor", False, 'ColorSA', False)
  
  E_port = PToken("port", False, 'ColorSA', False) # Use a Quad attribut
  E_d = PToken("d", False, 'ColorSA', False)
  ...
  E_widthRange = PToken("widthRange", False, 'HairRange', False)
  E_lengthRange = PToken("lengthRange", False, 'HairRange', False)
