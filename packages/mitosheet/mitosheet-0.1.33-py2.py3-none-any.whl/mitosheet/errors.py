...
def make_invalid_formula_error(formula: str):
    """
    ...
    return EditError(
        ...
        'Invalid Formula',
        f'Sorry, the formula \'{formula}\' is invalid. Did you type it correctly?'
    )
...
def make_invalid_column_headers_error(column_headers: str):
    """
...
def make_invalid_arguments_error(function):
    """
    Helper function for creating a invalid_arguments error.
