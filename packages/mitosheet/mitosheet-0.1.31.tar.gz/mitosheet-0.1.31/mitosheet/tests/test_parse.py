...
from ..parser import parse_formula, safe_replace
...
# TODO: add more errors for invalid formulas, improve error reporting here!
PARSE_TEST_ERRORS = [
    ('=A1', 'B', 'invalid_column_reference_error'),
    ('=FUNC(A) + FUNC(A, FUNC(A1))', 'B', 'invalid_column_reference_error'),
]
@pytest.mark.parametrize("formula, address, error_type", PARSE_TEST_ERRORS)
def test_parse_errors(formula, address, error_type):
