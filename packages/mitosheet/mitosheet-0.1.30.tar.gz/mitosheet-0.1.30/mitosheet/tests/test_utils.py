...
class MitoWidgetTestWrapper:
    ...
    def merge_sheets(self, sheet_index_one, merge_key_one, sheet_index_two, merge_key_two):
        self.mito_widget.receive_message(
            self.mito_widget,
            {
                'event': 'edit_event',
                ...
                'columns_to_keep_from_two': self.mito_widget.widget_state_container.dfs[sheet_index_two].keys()
            }
        )
