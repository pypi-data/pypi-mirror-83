...
class PlateService(BaseService):
    ...
    def bulk_get(
        ...
        plate_id_string = array_query_param(plate_ids)
        barcode_string = array_query_param(barcodes)
    ...
    @api_method
    def archive(self, archive_request: PlateArchiveRequest) -> PlateArchiveResponse:
