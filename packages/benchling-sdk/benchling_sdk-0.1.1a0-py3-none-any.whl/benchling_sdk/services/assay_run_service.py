...
class AssayRunService(BaseService):
    ...
    def automation_input_generators(self, assay_run_id: str) -> PageIterator[AutomationFile]:
        ...
        def results_extractor(body: AutomationFileInputList) -> Optional[List[AutomationFile]]:
    ...
    def automation_output_processors(self, assay_run_id: str) -> PageIterator[AutomationFile]:
        ...
        def results_extractor(body: AutomationFileOutputList) -> Optional[List[AutomationFile]]:
