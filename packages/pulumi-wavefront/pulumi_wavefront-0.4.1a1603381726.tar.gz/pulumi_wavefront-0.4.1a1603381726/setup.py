...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'wavefront', '0.4.1-alpha.1603381726+43c6e4cf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource wavefront 0.4.1-alpha.1603381726+43c6e4cf`
                """)
            else:
                raise
