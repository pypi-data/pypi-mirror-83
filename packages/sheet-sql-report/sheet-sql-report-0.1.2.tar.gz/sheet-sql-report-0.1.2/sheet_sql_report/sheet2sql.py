...
class SheetToSQL():
    ...
    def update_google_details(self, google_cloud_credentials):
        ...
        Args:
            - gc_credentials: JSON file of the access creddentials for the Google API. Need to use the Google Cloud website to set up a project for this and generate the creddentials
