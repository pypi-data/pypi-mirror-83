...
def default_config(folder='./'):
    ...
    from pdb_profiling.processors.pdbe.api import ProcessPDBe, PDBeModelServer
    ...
    # Change PDBeModelServer Mirror to RCSB's
    PDBeModelServer.root = 'https://models.rcsb.org/v1/'
