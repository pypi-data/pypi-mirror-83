...
class BaseWidget(Widget):
    ...
    def get_field_settings(cls, field_settings=None) -> dict:
        ...
        kelove_settings = getattr(settings, 'FIELD_SETTINGS_' + cls.field_settings_key, {})
        if not isinstance(kelove_settings, dict):
            kelove_settings = {}

        return {**cls.field_settings, **kelove_settings, **field_settings}
...
class CkFinderWidget(BaseWidget):
    ...
    def get_field_settings(cls, field_settings=None) -> dict:
        ...
        field_settings = super().get_field_settings(field_settings)
