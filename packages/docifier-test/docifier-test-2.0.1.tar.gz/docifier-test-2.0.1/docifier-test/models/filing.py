...
class Filing(object):
    ...
    def __init__(self, cik=None, form=None, symbol=None, filed_date=None, filing_url=None, report_url=None, accepted_date=None, access_number=None, local_vars_configuration=None):  # noqa: E501
