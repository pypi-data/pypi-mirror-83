...
class NewsSentiment(object):
    ...
    def __init__(self, buzz=None, symbol=None, sentiment=None, company_news_score=None, sector_average_news_score=None, sector_average_bullish_percent=None, local_vars_configuration=None):  # noqa: E501
