...
class IPOEvent(object):
    ...
    def __init__(self, date=None, name=None, price=None, status=None, symbol=None, exchange=None, number_of_shares=None, total_shares_value=None, local_vars_configuration=None):  # noqa: E501
