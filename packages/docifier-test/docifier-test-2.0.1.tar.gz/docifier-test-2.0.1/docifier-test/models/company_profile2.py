...
class CompanyProfile2(object):
    ...
    def __init__(self, ipo=None, logo=None, name=None, phone=None, ticker=None, weburl=None, country=None, currency=None, exchange=None, finnhub_industry=None, share_outstanding=None, market_capitalization=None, local_vars_configuration=None):  # noqa: E501
