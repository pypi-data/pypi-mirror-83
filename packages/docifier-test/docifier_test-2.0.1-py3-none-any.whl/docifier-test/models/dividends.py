...
class Dividends(object):
    ...
    def __init__(self, date=None, amount=None, symbol=None, pay_date=None, currency=None, record_date=None, adjusted_amount=None, declaration_date=None, local_vars_configuration=None):  # noqa: E501
