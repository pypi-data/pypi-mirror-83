...
class EarningRelease(object):
    ...
    def __init__(self, date=None, hour=None, year=None, symbol=None, quarter=None, eps_actual=None, eps_estimate=None, revenue_actual=None, revenue_estimate=None, local_vars_configuration=None):  # noqa: E501
