...
class FPLAnalytics:
    ...
    def getPlayerSummary(self, playerTypeCode=None, id=None, excludeZeroPoints = True, includeNextFixtures = 3):
        ...
        summaryCols = ['element', 'web_name', 'short_name', 'first_name', 'second_name', 'now_cost', 'element_type'] + game_stats + extra_stats + ['strength_attack_home', 'strength_attack_away', 'strength_defence_home', 'strength_defence_away']
