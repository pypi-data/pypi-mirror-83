...
class CreateSessionFromSnapshotOptions(object):
    ...
    def __init__(self, project_id=None, name=None, snapshot_id=None, session_params=None, command_name=None, command_params=None, shell=False, min_workers=None, max_workers=None, cluster_config=None, cloud_id=None, local_vars_configuration=None):  # noqa: E501
