...
"""Installer for the vdz.plone.projectreview package."""
...
package_name = 'vdz.plone.projectreview'
...
# see as well --> src/vdz/plone/projectreview/configure.zcml:
exclude_subpackages = (
        )
exclude_packages = []
...
setup_kwargs = dict(
    name=package_name,
    version=VERSION,
    description="Project reviews for Plone",
    ...
    install_requires=[
        'setuptools',
        'Products.CMFPlone >= 4.3'  # didn't try lower versions ...
             ', < 4.4',  # avoid v4.3.19, especially for fresh installs!
        # -*- Extra requirements: -*-
        'visaplan.zope.inputmacros >= 1.3.0.dev2',
        # relational database:
        'visaplan.zope.reldb >=1.0.0.dev2',
        'zope.sqlalchemy >=1.3',
        # ... and a database driver (e.g. psycopg2) for PostgreSQL databases.
        # resources (using Plone 4.3):
        'collective.js.datatables',
        'plonetheme.bootstrap',
        # 'collective.js.jqueryui',  # currently not used
        # 'collective.js.chosen',  (currently hopelessly outdated)
        # other tools and utilities: 
        # 'visaplan.plone.base',  # wg. v.p.tools.zcmlgen
        'visaplan.plone.infohubs >= 1.2.0.dev1',  # @@projectreview.pdf_view only
        'visaplan.plone.tools >= 1.2.2.dev9',  # .groups module
        'visaplan.tools >=1.3.1.dev5',
