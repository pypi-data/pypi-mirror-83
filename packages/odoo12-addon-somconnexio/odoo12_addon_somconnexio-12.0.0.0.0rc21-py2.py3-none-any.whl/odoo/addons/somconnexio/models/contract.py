...
from ..opencell_services.crm_account_hierarchy \
...
class Contract(models.Model):
    ...
    date_start = fields.Date(
        compute='_compute_date_start', string='Date End', store=True
    )
    ...
    @api.depends(
        ...
        'orange_adsl_service_contract_info_id.phone_number',
    ...
    def _compute_phone_number(self):
        ...
        if contract_type == 'mobile':
            ...
            self.phone_number = (
                self.orange_adsl_service_contract_info_id.phone_number
            )
