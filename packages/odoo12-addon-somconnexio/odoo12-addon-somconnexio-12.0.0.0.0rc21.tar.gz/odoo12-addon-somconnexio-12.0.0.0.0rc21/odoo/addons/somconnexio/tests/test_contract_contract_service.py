...
class TestContractController(BaseEMCRestCaseAdmin):
    ...
    def test_route_right_adsl(self, _):
        ...
        self.assertEquals(
            contract.name,
            data['orange_adsl_contract_service_info']['phone_number']
        )
    ...
    def test_route_right_orange_fiber(self, _):
        url = "/public-api/contract"
        data = {
            "partner_id": self.partner_id,
            "service_address": self.service_address,
        ...
        self.assertEquals(
            contract.name,
            data['orange_fiber_contract_service_info']['phone_number']
        )
