...
from . import test_customer_data_from_res_partner
...
from .opencell_services import test_crm_account_hierarchy as test_crm_account_hierarchy_from_contract_service
