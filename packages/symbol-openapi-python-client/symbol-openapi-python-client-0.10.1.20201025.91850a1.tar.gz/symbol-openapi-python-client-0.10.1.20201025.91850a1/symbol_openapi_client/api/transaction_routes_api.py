...
class TransactionRoutesApi(object):
    ...
    def search_confirmed_transactions(self, **kwargs):  # noqa: E501
        ...
        :param int from_transfer_amount: Requires providing the `transferMosaicId` filter. Only transfer transactions with a transfer amount of the provided mosaic id, greater or equal than this amount are returned. 
        :param int to_transfer_amount: Requires providing the `transferMosaicId` filter. Only transfer transactions with a transfer amount of the provided mosaic id, lesser or equal than this amount are returned. 
