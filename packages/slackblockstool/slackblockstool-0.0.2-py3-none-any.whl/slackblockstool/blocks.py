...
class ElementButton(Element):
    def __init__(self, text: Union[ObjectMrkdwnText, ObjectPlainText], action_id: str, url: str = None,
...
class ElementDatepicker(Element):
    def __init__(self, action_id: str, placeholder: Union[ObjectMrkdwnText, ObjectPlainText] = None,
...
class ElementSelectWithStatic(Element):
    def __init__(self, placeholder: Union[ObjectMrkdwnText, ObjectPlainText], action_id: str,
...
class BlockSection(Block):
    def __init__(self, text: Union[ObjectMrkdwnText, ObjectPlainText], block_id: str = None,
                 fields: List[Union[ObjectMrkdwnText, ObjectPlainText]] = None, accessory: Element = None):
...
class BlockImage(Block):
    def __init__(self, image_url: str, alt_text: str,
                 title: Union[ObjectMrkdwnText, ObjectPlainText] = None, block_id: str = None):
...
class BlockInput(Block):
    def __init__(self, label: Union[ObjectMrkdwnText, ObjectPlainText], element: Element,
