...
[boto3.AugmentedAIRuntime 1.16.6](https://boto3.amazonaws.com/v1/documentation/api/1.16.6/reference/services/sagemaker-a2i-runtime.html#AugmentedAIRuntime) service
compatible with
