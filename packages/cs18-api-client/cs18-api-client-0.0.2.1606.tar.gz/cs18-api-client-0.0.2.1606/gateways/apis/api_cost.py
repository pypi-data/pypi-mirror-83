...
class ApiCost(ApiBase):
    ...
    def forecast(self, space_name: str, start_date: str, end_date: str):
        return self.build_route("spaces/{space_name}/cost/cloud_accounts?start_date={start_date}&end_date={end_date}".format(**locals()))
