...
from gateways.common.cs18_api_responses import (
    ...
    BlueprintValidationResponse, BlueprintValidationSourceResponse)
...
class Converters:
    ...
    @staticmethod
    def create_blueprint_validation_source_response(source: dict) -> Optional[BlueprintValidationSourceResponse]:
        if not source:
            return None
        return BlueprintValidationSourceResponse(
