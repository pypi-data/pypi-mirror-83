...
async function waitResultMust(callback, waitMs = 1000, interval = 1) {
...
describe('Unit Test for TrialDispatcher', () => {
    ...
    beforeEach(async () => {
        ...
        component.Container.bind(environment_1.EnvironmentService)
            .to(utEnvironmentService_1.UtEnvironmentService)
        ...
        environmentService = component.get(environment_1.EnvironmentService);
