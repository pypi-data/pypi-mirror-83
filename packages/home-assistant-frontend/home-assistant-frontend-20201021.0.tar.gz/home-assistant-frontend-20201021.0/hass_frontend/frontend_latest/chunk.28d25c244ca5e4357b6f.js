/*! For license information please see chunk.28d25c244ca5e4357b6f.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[368],{59947:(e,t,a)=>{"use strict";var o=a(87480),i=a(15652),r=(a(21083),a(98734)),n=a(81471);class d extends i.oi{constructor(){super(...arguments),this.mini=!1,this.exited=!1,this.disabled=!1,this.extended=!1,this.showIconAtEnd=!1,this.reducedTouchTarget=!1,this.icon="",this.label="",this.shouldRenderRipple=!1,this.rippleHandlers=new r.A(()=>(this.shouldRenderRipple=!0,this.ripple))}createRenderRoot(){return this.attachShadow({mode:"open",delegatesFocus:!0})}render(){const e=this.mini&&!this.reducedTouchTarget,t={"mdc-fab--mini":this.mini,"mdc-fab--touch":e,"mdc-fab--exited":this.exited,"mdc-fab--extended":this.extended,"icon-end":this.showIconAtEnd},a=this.label?this.label:this.icon;return i.dy`
      <button
          class="mdc-fab ${(0,n.$)(t)}"
...
<div id="checkboxLabel"><slot></slot></div>`;l.setAttribute("strip-whitespace",""),(0,r.k)({_template:l,is:"paper-checkbox",behaviors:[o.K],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){(0,d.T8)(this,(function(){if("-1px"===this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim()){var e=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),t="px",a=e.match(/[A-Za-z]+$/);null!==a&&(t=a[0]);var o=parseFloat(e),i=8/3*o;"px"===t&&(i=Math.floor(i))%2!=o%2&&i++,this.updateStyles({"--paper-checkbox-ink-size":i+t})}}))},_computeCheckboxClass:function(e,t){var a="";return e&&(a+="checked "),t&&(a+="invalid"),a},_computeCheckmarkClass:function(e){return e?"":"hidden"},_createRipple:function(){return this._rippleContainer=this.$.checkboxContainer,i.S._createRipple.call(this)}})},46002:(e,t,a)=>{"use strict";a(43437),a(8621),a(63207),a(26900),a(1656),a(57548),a(73962);var o=a(51644),i=a(26110),r=a(21006),n=a(98235),d=a(84938),l=a(9672),c=a(87156),p=a(81668),s=a(50856);(0,l.k)({_template:s.d`
...
//# sourceMappingURL=chunk.28d25c244ca5e4357b6f.js.map