/*! For license information please see chunk.60306f24c8fb204dcc32.js.LICENSE.txt */
...
`;!function(e,t,r,i){var n=a();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var s=t((function(e){n.initializeInstanceElements(e,p.elements)}),r),p=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(f(o.descriptor)||f(n.descriptor)){if(d(o)||d(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(d(o)){if(d(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}c(o,n)}else t.push(o)}return t}(s.d.map(l)),e);n.initializeClassElements(s.F,p.elements),n.runClassFinishers(s.F,p.finishers)}([(0,o.Mo)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"method",key:"scrollToPos",value:function(e,t){this.contentElement.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return o.dy`<slot name="heading">
    ...
    `:i.dy``}},{kind:"method",key:"_startRefresh",value:function(){this._subscribe()}},{kind:"method",key:"_handleMessage",value:function(e){"node_updated"===e.type&&(this._node=e,"Complete"===e.node_query_stage&&(this._unsubscribe(),this._complete=!0))}},{kind:"method",key:"_unsubscribe",value:function(){this._active=!1,this._refreshDevicesTimeoutHandle&&clearTimeout(this._refreshDevicesTimeoutHandle),this._subscribed&&(this._subscribed.then((e=>e())),this._subscribed=void 0)}},{kind:"method",key:"_subscribe",value:function(){this.hass&&(this._active=!0,this._subscribed=this.hass.connection.subscribeMessage((e=>this._handleMessage(e)),{type:"ozw/refresh_node_info",node_id:this._node_id,ozw_instance:this._ozw_instance}),this._refreshDevicesTimeoutHandle=window.setTimeout((()=>this._unsubscribe()),12e4))}},{kind:"method",key:"_close",value:function(){this._complete=!1,this._node_id=void 0,this._node=void 0}},{kind:"get",static:!0,key:"styles",value:function(){return[o.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=chunk.60306f24c8fb204dcc32.js.map