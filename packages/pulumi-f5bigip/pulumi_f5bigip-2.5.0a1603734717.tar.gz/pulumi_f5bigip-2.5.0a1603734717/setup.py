...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.5.0-alpha.1603734717+92c65e0d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.5.0-alpha.1603734717+92c65e0d`
                """)
            else:
                raise
