...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.5.0-alpha.1603733404+8f530e15'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.5.0-alpha.1603733404+8f530e15`
                """)
            else:
                raise
