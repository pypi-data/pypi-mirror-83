...
ext_modules = [
    CppExtension('torch_sparse_old.spspmm_cpu', ['cpu/spspmm.cpp'],
...
if CUDA_HOME is not None and GPU:
    ...
    ext_modules += [
        CUDAExtension('torch_sparse_old.spspmm_cuda',
                      ['cuda/spspmm.cpp', 'cuda/spspmm_kernel.cu'],
                      extra_link_args=extra_link_args,
                      extra_compile_args=extra_compile_args),
        CUDAExtension('torch_sparse_old.unique_cuda',
