import torch
from torch_sparse_old import transpose, to_scipy, from_scipy, coalesce

import torch_sparse_old.spspmm_cpu

if torch.cuda.is_available():
    import torch_sparse_old.spspmm_cuda
    ...
    def backward(ctx, grad_indexC, grad_valueC):
        ...
        if not grad_valueC.is_cuda:
            ...
            if ctx.needs_input_grad[1]:
                grad_valueA = torch_sparse_old.spspmm_cpu.spspmm_bw(
            ...
            if ctx.needs_input_grad[3]:
                ...
                grad_valueB = torch_sparse_old.spspmm_cpu.spspmm_bw(
                    indexB, indexA.detach(), valueA, indexC.detach(),
                    grad_valueC, k, n)
        else:
            if ctx.needs_input_grad[1]:
                grad_valueA = torch_sparse_old.spspmm_cuda.spspmm_bw(
