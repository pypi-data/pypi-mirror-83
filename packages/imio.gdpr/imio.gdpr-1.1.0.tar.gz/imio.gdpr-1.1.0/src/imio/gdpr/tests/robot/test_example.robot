...
#
#  $ bin/test -s imio.gdpr -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imio.gdpr.testing.IMIO_GDPR_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imio/gdpr/tests/robot/test_example.robot
#
