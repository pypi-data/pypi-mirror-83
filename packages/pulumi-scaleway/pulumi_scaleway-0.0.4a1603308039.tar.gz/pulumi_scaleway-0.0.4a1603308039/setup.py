...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', '0.0.4-alpha.1603308039+72071e72'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway 0.0.4-alpha.1603308039+72071e72`
                """)
            else:
                raise
