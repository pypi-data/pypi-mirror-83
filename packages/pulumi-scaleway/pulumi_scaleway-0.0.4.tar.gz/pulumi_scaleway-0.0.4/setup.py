...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', '0.0.4', '--server', 'https://bintray.com/jaxxstorm/pulumi/download_file?file_path='])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway 0.0.4`
                """)
            else:
                raise
