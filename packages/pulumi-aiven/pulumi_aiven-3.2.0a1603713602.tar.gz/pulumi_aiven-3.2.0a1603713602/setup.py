...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.2.0-alpha.1603713602+8a5e9a79'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.2.0-alpha.1603713602+8a5e9a79`
                """)
            else:
                raise
