...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '3.3.0-alpha.1603901560+6d0de04d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 3.3.0-alpha.1603901560+6d0de04d`
                """)
            else:
                raise
