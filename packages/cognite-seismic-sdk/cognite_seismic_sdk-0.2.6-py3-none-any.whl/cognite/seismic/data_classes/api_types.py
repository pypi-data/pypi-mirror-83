...
if not os.getenv("READ_THE_DOCS"):
    from cognite.seismic.protos.types_pb2 import Geometry as GeometryProto, IngestionSource, CRS as CRSProto
...
class SeismicStore:
    ...
    def __repr__(self):
        return f"SeismicStore<id: {self.id}, name: {self.name}, survey_id: {self.survey_id}, ingestion_source: {self.ingestion_source}, metadata: {self.metadata}>"
