...
class MeApi(object):
    ...
    def api_v1_me_get(self, **kwargs):  # noqa: E501
        """api_v1_me_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_me_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_v1_me_get_with_http_info(**kwargs)  # noqa: E501

    def api_v1_me_get_with_http_info(self, **kwargs):  # noqa: E501
        """api_v1_me_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_me_get_with_http_info(async_req=True)
        >>> result = thread.get()
