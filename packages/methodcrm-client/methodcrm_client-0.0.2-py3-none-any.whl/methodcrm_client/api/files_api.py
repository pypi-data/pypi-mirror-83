...
from methodcrm_client.api_client import ApiClient
from methodcrm_client.exceptions import (  # noqa: F401
    ApiTypeError,
    ApiValueError
)
...
class FilesApi(object):
    ...
    def file_delete(self, id, **kwargs):  # noqa: E501
        """Delete File  # noqa: E501

        To delete a file, specify the file `{id}` in the URL path.    ### Examples  To delete a file with ID = 9a14f324-59df-44b5-af1e-c7689b891b54.    ```http  DELETE /api/v1/files/9a14f324-59df-44b5-af1e-c7689b891b54/url HTTP/1.1  Host: https://rest.method.me  Authorization: APIKey NWYyZDhlZDJiYTBj  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.file_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.file_delete_with_http_info(id, **kwargs)  # noqa: E501

    def file_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete File  # noqa: E501
        ...
        >>> thread = api.file_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def file_download(self, id, **kwargs):  # noqa: E501
        """Download File  # noqa: E501

        To download a file, specify the file `{id}` in the URL path.      ### Examples  To download a file with ID = 9a14f324-59df-44b5-af1e-c7689b891b54.    ```http  GET /api/v1/files/9a14f324-59df-44b5-af1e-c7689b891b54/download HTTP/1.1  Host: https://rest.method.me  Authorization: APIKey NWYyZDhlZDJiYTBj  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.file_download(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.file_download_with_http_info(id, **kwargs)  # noqa: E501

    def file_download_with_http_info(self, id, **kwargs):  # noqa: E501
        """Download File  # noqa: E501
        ...
        >>> thread = api.file_download_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def file_link_update(self, id, **kwargs):  # noqa: E501
        """Update File Link Details  # noqa: E501

        To update the linked details for a file,   specify the file `{id}` in the URL path and link details in the request body. Currently, we support only the update of attachToEmail field to update link details.        ### Examples  To update link details for a file with Id = \"2a5e1cbc-c9c7-4d72-b554-026e8467cd7f\".    ```http  PUT /api/v1/files/2a5e1cbc-c9c7-4d72-b554-026e8467cd7f HTTP/1.1  Host: https://rest.method.me  Authorization: APIKey NWYyZDhlZDJiYTB  Content-Type: application/json    {      \"tableName\": \"Contacts\",      \"recordId\": 4,      \"attachToEmail\" : false  }  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.file_link_update(id, async_req=True)
        >>> result = thread.get()

        :param id: Id (required)
        :type id: str
        :param file_link:
        :type file_link: FileLink
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.file_link_update_with_http_info(id, **kwargs)  # noqa: E501

    def file_link_update_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update File Link Details  # noqa: E501
        ...
        >>> thread = api.file_link_update_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method file_link_update" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'file_link' in local_var_params:
            body_params = local_var_params['file_link']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def file_upload(self, **kwargs):  # noqa: E501
        ...
        To upload a file and link it to a record in a table.  > 📌 __**Note**__  Upload file size limit is 50MB and the total storage limit for your account is 10GB. If you upload a file with a size greater than 50 MB, the server will return a 413 response.    ### Examples  To upload and link a file to RecordId 4 of the Contacts table.    ```http  POST /api/v1/files HTTP/1.1  Host: https://rest.method.me  Authorization: APIKey NWYyZDhlZDJiYTBj    ----WebKitFormBoundary7MA4YWxkTrZu0gW  Content-Disposition: form-data; name=\"\"; filename=\"/D:/Desktop/report.pdf\"  Content-Type: application/pdf    (data)  ----WebKitFormBoundary7MA4YWxkTrZu0gW  Content-Disposition: form-data; name=\"table\"    Contacts  ----WebKitFormBoundary7MA4YWxkTrZu0gW  Content-Disposition: form-data; name=\"recordId\"    4  ----WebKitFormBoundary7MA4YWxkTrZu0gW  Content-Disposition: form-data; name=\"attachToEmail\"    true  ----WebKitFormBoundary7MA4YWxkTrZu0gW  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def file_upload_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'table' in local_var_params:
            form_params.append(('table', local_var_params['table']))  # noqa: E501
        if 'record_id' in local_var_params:
            form_params.append(('recordId', local_var_params['record_id']))  # noqa: E501
        if 'attach_to_email' in local_var_params:
            form_params.append(('attachToEmail', local_var_params['attach_to_email']))  # noqa: E501
    ...
    def file_url(self, id, **kwargs):  # noqa: E501
        """Get File URL  # noqa: E501

        To get a download link for a file, specify the file `{id}` in the URL path.  > 📌 __**Note**__ For better security of file data, this file URL will expire after 20 minutes and users have to generate a new URL.        ### Examples  To get download link for a file with ID = 9a14f324-59df-44b5-af1e-c7689b891b54.     ```http  GET /api/v1/files/9a14f324-59df-44b5-af1e-c7689b891b54/url HTTP/1.1  Host: https://rest.method.me  Authorization: APIKey NWYyZDhlZDJiYTBj  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.file_url(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.file_url_with_http_info(id, **kwargs)  # noqa: E501

    def file_url_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get File URL  # noqa: E501
        ...
        >>> thread = api.file_url_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def files_list(self, **kwargs):  # noqa: E501
        """Get File List  # noqa: E501

        To request data about files attached to a record in a Table. Specify `{table}` and `{recordId}` in query parameters.       ### Examples  To get all files linked to RecordId 4 of Contacts table.    ```http      GET /api/v1/files?table=Contacts&recordId=4 HTTP/1.1      Host: https://rest.method.me      Authorization: APIKey NWYyZDhlZDJiYTBjOD  ```  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :type table: str
        :param record_id: RecordId of the record
        :type record_id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def files_list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[FileMetadata], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if 'record_id' in local_var_params and local_var_params['record_id'] is not None:  # noqa: E501
            query_params.append(('recordId', local_var_params['record_id']))  # noqa: E501
