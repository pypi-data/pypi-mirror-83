...
import methodcrm_client.models
from methodcrm_client import rest
from methodcrm_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(methodcrm_client.models, klass)
