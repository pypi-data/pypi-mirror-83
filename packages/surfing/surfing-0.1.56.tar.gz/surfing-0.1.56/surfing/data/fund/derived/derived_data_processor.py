...
from .fund_indicator_processor_ipo_conv import FundIndicatorProcessorIPOConv
...
class DerivedDataProcessor:
    def __init__(self):
        ...
        self.fund_indicator_processor_ipo_conv = FundIndicatorProcessorIPOConv(self._data_helper)
    ...
    def process_all(self, start_date, end_date):
        ...
        failed_tasks.extend(self.fund_indicator_processor_ipo_conv.process(start_date, end_date))
