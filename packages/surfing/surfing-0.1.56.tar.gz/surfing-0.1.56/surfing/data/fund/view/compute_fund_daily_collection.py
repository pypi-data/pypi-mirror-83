...
from ...view.basic_models import FundNav, FundInfo, FundRate, FundSize, FundRet, FundBenchmark, IndexInfo, \
    FundStatusLatest
from ...view.derived_models import FundAlpha, FundScore, FundIndicator, FundScoreNew
...
class FundDailyCollectionProcessor(object):
    ...
    def compute_daily_collection(self):
        try:
            ...
            print('处理净值')
            df = pd.concat([funds, bench, nav, alpha, size, rating, score, new_score, tag_indicator, exchange_status], axis=1, sort=False)
