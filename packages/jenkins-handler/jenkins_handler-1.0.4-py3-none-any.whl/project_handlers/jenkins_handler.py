...
from scripts.helpers.jenkins_wrapper.jenkins_job import JenkinsJobList, JenkinsJob
from scripts.helpers.jenkins_wrapper.jenkins_logs_parser import JobLogParserFactory
...
def get_agent_jenkins_handler(branch: str) -> AgentJenkinsHandler:
    server = jenkins.Jenkins(url=JENKINS_URL, username=JENKINS_USERNAME, password=JENKINS_PASSWORD)
