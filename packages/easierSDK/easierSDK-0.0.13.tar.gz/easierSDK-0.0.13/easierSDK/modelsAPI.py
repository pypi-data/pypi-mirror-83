...
class ModelsAPI():
    ...
    def load_from_local(self, path:str, print_files=True):
        model = Model()
        for obj in os.listdir(path):
            ...
            if extension == constants.MODEL_EXTENSION:
                ...
                if print_files: print("File extension not known: ." + str(extension))
        # print("Load complete. Files are stored in: " + path)
        
        return model

    def load_from_repository(self, repo_name:str, category:Categories, model_name:str, print_files=True):
