...
class ModelsAPI():
    ...
    def download(self, repo_name:str, category:Categories, model_name:str, path_to_download:str):
        ...
        try:
            ...
            for minio_object in objects:
                minio_obj = self.minio_client.fget_object(repo_name, minio_object.object_name, local_path + "/" + minio_object.object_name)
        except minio.error.NoSuchKey as ex:
    ...
    def load_from_repository(self, repo_name:str, category:Categories, model_name:str):
        ...
        for obj in os.listdir(path):
            ...
            if extension == constants.MODEL_EXTENSION:
                ...
                print("File extension not known: ." + str(extension))
        print("Load complete. Files are stored in: " + path)
        return model
