...
iconPath = os.path.join(this_dir,'res','bigicon.png')
picPath = os.path.join(this_dir,'res','default.png')
class pic:
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(pkg_resources.resource_filename("pythonimageconvert","res/bigicon.png" )))
