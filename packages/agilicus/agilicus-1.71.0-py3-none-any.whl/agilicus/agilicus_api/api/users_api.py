...
"""
    ...
    The version of the OpenAPI document: 2020.10.22
...
class UsersApi(object):
    ...
    def list_combined_user_details_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email', 'previous_email', 'org_id', 'limit', 'type', 'user_id', 'status', 'mfa_enrolled', 'auto_created', 'search_direction']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['email', 'previous_email', 'provider', 'org_id', 'issuer', 'limit', 'type', 'upstream_user_id', 'upstream_idp_id', 'status', 'search_direction', 'has_roles']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
