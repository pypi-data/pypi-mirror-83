...
def check_response(request_func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if resp.status_code == 400:
            ...
            raise ToManyRequests(resp.text)
...
class Forbidden(Exception):
    ...
    def __str__(self):
        return 'ClickSign API Error: Forbidden! Please verify if your token is valid and if you are in the right environment. The server response was: {self.error}.'
...
class Unauthorized(Exception):
    ...
    def __str__(self):
        return 'ClickSign API Error: Unauthorized! Invalid token. The server response was: {self.error}.'
...
class UnProcessableEntity(Exception):
    ...
    def __str__(self):
        return f'ClickSign API Error: UnProcessableEntity! The server was not able to process the request. The server response was: {self.error}.'
...
class NotFound(Exception):
    ...
    def __str__(self):
        return 'ClickSign API Error: NotFound! The server was not able to find this recurse. The server response was: {self.error}.'
...
class ToManyRequests(Exception):
    ...
    def __str__(self):
        return 'ClickSign API Error: ToManyRequests! You do reach the request rate limit! The server response was: {self.error}.'
...
class UnknownServerError(Exception):
    ...
    def __str__(self):
        return 'ClickSign API Error: UnknownServerError! The server was not able to process the request. Internal server error. The server response was: {self.error}.'
