...
class DtkAsyncApi(object):
    ...
    async def goods_price_trend(self, args: GoodsPriceTrendArgs) -> Optional[dict]:
        ...
        """
        return await self._inner.goods_price_trend(args)
    ...
    async def goods_explosive_goods_list(
        ...
        return await self._inner.goods_explosive_goods_list(args)
    ...
    async def goods_exclusive_goods_list(
        ...
        return await self._inner.goods_exclusive_goods_list(args)

    async def tb_service_activity_link(
        self, args: TbServiceActivityLinkArgs
    ) -> Optional[dict]:
        return await self._inner.tb_service_activity_link(args)
    ...
    async def tb_service_creat_taokouling(
        ...
        return await self._inner.tb_service_creat_taokouling(args)
    ...
    async def tb_service_parse_taokouling(
        ...
        return await self._inner.tb_service_parse_taokouling(args)
    ...
    async def goods_nine_op_goods_list(
        ...
        return await self._inner.goods_nine_op_goods_list(args)

    async def category_ddq_goods_list(
        self, args: CategoryDdqGoodsListArgs
    ) -> Optional[dict]:
        return await self._inner.category_ddq_goods_list(args)

    async def goods_get_ranking_list(
        self, args: GoodsGetRankingListArgs
    ) -> Optional[dict]:
        return await self._inner.goods_get_ranking_list(args)
    ...
    async def goods_topic_catalogue(self) -> Optional[dict]:
        return await self._inner.goods_topic_catalogue()
    ...
    async def goods_activity_catalogue(self) -> Optional[dict]:
        return await self._inner.goods_activity_catalogue()
