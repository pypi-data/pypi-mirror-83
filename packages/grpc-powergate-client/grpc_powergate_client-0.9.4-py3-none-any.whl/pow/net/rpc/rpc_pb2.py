...
_CONNECTEDNESS = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='CONNECTEDNESS_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONNECTEDNESS_NOT_CONNECTED', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONNECTEDNESS_CONNECTED', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONNECTEDNESS_CAN_CONNECT', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONNECTEDNESS_CANNOT_CONNECT', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CONNECTEDNESS_ERROR', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_PEERADDRINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='net.rpc.PeerAddrInfo.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='addrs', full_name='net.rpc.PeerAddrInfo.addrs', index=1,
...
_LOCATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='country', full_name='net.rpc.Location.country', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='latitude', full_name='net.rpc.Location.latitude', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='longitude', full_name='net.rpc.Location.longitude', index=2,
...
_PEERINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='addr_info', full_name='net.rpc.PeerInfo.addr_info', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='location', full_name='net.rpc.PeerInfo.location', index=1,
...
_LISTENADDRRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='addr_info', full_name='net.rpc.ListenAddrResponse.addr_info', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PEERSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='peers', full_name='net.rpc.PeersResponse.peers', index=0,
...
_FINDPEERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='peer_id', full_name='net.rpc.FindPeerRequest.peer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FINDPEERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='peer_info', full_name='net.rpc.FindPeerResponse.peer_info', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONNECTEDNESSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='peer_id', full_name='net.rpc.ConnectednessRequest.peer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONNECTEDNESSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='connectedness', full_name='net.rpc.ConnectednessResponse.connectedness', index=0,
...
PeerAddrInfo = _reflection.GeneratedProtocolMessageType('PeerAddrInfo', (_message.Message,), {
  'DESCRIPTOR' : _PEERADDRINFO,
  '__module__' : 'net.rpc.rpc_pb2'
...
ListenAddrRequest = _reflection.GeneratedProtocolMessageType('ListenAddrRequest', (_message.Message,), {
...
ListenAddrResponse = _reflection.GeneratedProtocolMessageType('ListenAddrResponse', (_message.Message,), {
...
FindPeerRequest = _reflection.GeneratedProtocolMessageType('FindPeerRequest', (_message.Message,), {
...
FindPeerResponse = _reflection.GeneratedProtocolMessageType('FindPeerResponse', (_message.Message,), {
...
ConnectednessRequest = _reflection.GeneratedProtocolMessageType('ConnectednessRequest', (_message.Message,), {
...
ConnectednessResponse = _reflection.GeneratedProtocolMessageType('ConnectednessResponse', (_message.Message,), {
