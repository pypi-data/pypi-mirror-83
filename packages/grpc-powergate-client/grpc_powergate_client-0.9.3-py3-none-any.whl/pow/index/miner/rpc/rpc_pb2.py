...
_INDEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='meta', full_name='index.miner.rpc.Index.meta', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='chain', full_name='index.miner.rpc.Index.chain', index=1,
...
_ONCHAININDEX_MINERSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='index.miner.rpc.OnChainIndex.MinersEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='index.miner.rpc.OnChainIndex.MinersEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ONCHAININDEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='last_updated', full_name='index.miner.rpc.OnChainIndex.last_updated', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='miners', full_name='index.miner.rpc.OnChainIndex.miners', index=1,
...
_ONCHAINDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='power', full_name='index.miner.rpc.OnChainData.power', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='relative_power', full_name='index.miner.rpc.OnChainData.relative_power', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sector_size', full_name='index.miner.rpc.OnChainData.sector_size', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='active_deals', full_name='index.miner.rpc.OnChainData.active_deals', index=3,
...
_METAINDEX_INFOENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='index.miner.rpc.MetaIndex.InfoEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='index.miner.rpc.MetaIndex.InfoEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METAINDEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='online', full_name='index.miner.rpc.MetaIndex.online', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='offline', full_name='index.miner.rpc.MetaIndex.offline', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='info', full_name='index.miner.rpc.MetaIndex.info', index=2,
...
_META = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='last_updated', full_name='index.miner.rpc.Meta.last_updated', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user_agent', full_name='index.miner.rpc.Meta.user_agent', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='location', full_name='index.miner.rpc.Meta.location', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='online', full_name='index.miner.rpc.Meta.online', index=3,
...
_LOCATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='country', full_name='index.miner.rpc.Location.country', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='longitude', full_name='index.miner.rpc.Location.longitude', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='latitude', full_name='index.miner.rpc.Location.latitude', index=2,
...
_GETRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='index', full_name='index.miner.rpc.GetResponse.index', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Index = _reflection.GeneratedProtocolMessageType('Index', (_message.Message,), {
  'DESCRIPTOR' : _INDEX,
  '__module__' : 'index.miner.rpc.rpc_pb2'
  # @@protoc_insertion_point(class_scope:index.miner.rpc.Index)
  })
_sym_db.RegisterMessage(Index)

OnChainIndex = _reflection.GeneratedProtocolMessageType('OnChainIndex', (_message.Message,), {

  'MinersEntry' : _reflection.GeneratedProtocolMessageType('MinersEntry', (_message.Message,), {
...
OnChainData = _reflection.GeneratedProtocolMessageType('OnChainData', (_message.Message,), {
...
MetaIndex = _reflection.GeneratedProtocolMessageType('MetaIndex', (_message.Message,), {
