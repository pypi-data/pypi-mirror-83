...
class ArraySerializer(ObjectSerializer):
    ...
    def serialize(
        ...
        elif output_model.__name__ == RestSchemaTypes.ARRAY.value:
            return parse_obj_as(output_model, value.tolist()).__root__
        elif output_model.__name__ == RestSchemaTypes.SERIES.value:
