...
class EndpointSchema(ABC):
    def __init__(self, value: Any, endpoint_kind: str):
        ...
        self.pydantic: Type[CustomDeserializingModelT] = to_pydantic(value)
...
class EndpointOutputSchema(EndpointSchema):
    ...
    def get_pandas_representation(self, type_cast=None):
...
def get_model_names(model: Type[CustomDeserializingModelT]):
    schema = model.schema()
