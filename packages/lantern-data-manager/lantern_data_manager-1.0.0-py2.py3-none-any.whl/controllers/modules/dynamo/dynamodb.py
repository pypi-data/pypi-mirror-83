...
import logging
import time
from controllers.utils.json import json_float_to_decimal
from controllers.utils.request import http_response, http_error, res_failed
...
class DynamoController(object):
    ...
    def __init__(self, table_name, debug=False):
        ...
        Args:
            table_name (string): table name to perform query
            debug (bool, optional): Defaults to False.

        Raises:
            Exception: table_name can not be empty
        """
        if not table_name:
    ...
    def create(self, data):
        ...
        Args:
            data (dict): data to insert into dynamo
        """
    ...
    def update(self, primary_keys, data):
        ...
        Args:
            primary_keys (dict) : PK and SK of row to update
            data (dict): data to update in row

        Returns:
            dict: returns record updated
        """
    ...
    def delete(self, primary_keys):
        ...
        Args:
            primary_keys (dict) : PK and SK of row to delete
    ...
    def delete_batch(self, primary_keys):
        ...
        Args:
            primary_keys (dict) : PK and SK of rows to delete

        Returns:
            (string): 'Deleted item(s)'
        """
