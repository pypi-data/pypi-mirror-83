...
def androidreportcmd():
    global FileFullPath
    Usgstr='''
Usage : Generated Android Report
        '''
    argDict=getArg(usagestr=Usgstr, customarg='timezone')
    if argDict:
        file=argDict['main']
        timezone=argDict['timezone']  if argDict.get('timezone') else 'in'
        androidReport(file=file, timezone=timezone)
...
if __name__ == '__main__' :
    reports = androidReport(file='E:/PY/activity/sib/takeout-20201001T044940Z-001.zip', apps=20)
