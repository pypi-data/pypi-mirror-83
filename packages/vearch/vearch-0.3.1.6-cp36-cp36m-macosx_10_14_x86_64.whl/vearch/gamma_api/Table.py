...
def TableAddRetrievalType(builder, retrievalType): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(retrievalType), 0)
def TableAddRetrievalParam(builder, retrievalParam): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(retrievalParam), 0)
