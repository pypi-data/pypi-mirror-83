...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.6.0-alpha.1603381226+9ee9102d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.6.0-alpha.1603381226+9ee9102d`
                """)
            else:
                raise
