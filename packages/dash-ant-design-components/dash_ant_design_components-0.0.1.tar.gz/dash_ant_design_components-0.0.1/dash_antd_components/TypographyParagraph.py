...
class TypographyParagraph(Component):
    """A TypographyParagraph component.
...
- underline (boolean; optional): Underlined style	boolean	false"""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, className=Component.UNDEFINED, code=Component.UNDEFINED, copyable=Component.UNDEFINED, delete=Component.UNDEFINED, disabled=Component.UNDEFINED, editable=Component.UNDEFINED, ellipsis=Component.UNDEFINED, mark=Component.UNDEFINED, strong=Component.UNDEFINED, type=Component.UNDEFINED, underline=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'code', 'copyable', 'delete', 'disabled', 'editable', 'ellipsis', 'mark', 'strong', 'type', 'underline']
        self._type = 'TypographyParagraph'
        self._namespace = 'dash_antd_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'code', 'copyable', 'delete', 'disabled', 'editable', 'ellipsis', 'mark', 'strong', 'type', 'underline']
        ...
        super(TypographyParagraph, self).__init__(children=children, **args)
