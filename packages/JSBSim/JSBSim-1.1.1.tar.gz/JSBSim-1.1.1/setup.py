...
if 'sdist' not in dist.commands and compiler.find_library_file([library_path],
    ...
    # the sources.
    if compiler.compiler_type == 'msvc':
        compile_flags = [('/D'+flag).replace('"', '\\"') for flag in ['JSBSIM_VERSION="1.1.1 [GitHub build 134/commit c11b0ac53846798bca8f60132ebf8df935e1a802]"','HAVE_EXPAT_CONFIG_H',]]
    else:
        compile_flags = ['-D'+flag for flag in ['JSBSIM_VERSION="1.1.1 [GitHub build 134/commit c11b0ac53846798bca8f60132ebf8df935e1a802]"','HAVE_EXPAT_CONFIG_H',]]
