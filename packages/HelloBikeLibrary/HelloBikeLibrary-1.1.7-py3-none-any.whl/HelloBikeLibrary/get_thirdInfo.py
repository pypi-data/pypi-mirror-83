...
# @Last Modified time: 2020-10-21 18:13:48
	...
	def get_container_ip(self,service_name,env="uat",tag="group1"):
		...
		try:
			...
			if env == "fat":
				...
				groupsUrl = "https://gaia.hellobike.cn/container-business-service/api/v1/apps/groups/appname/{}/env/4".format(service_name)
				containerUrl = "https://gaia.hellobike.cn/container-business-service/api/v1/apps/pods/appname/{service_name}/env/4/group/{tag}".format(
				service_name=service_name,tag=tag)
			else:
