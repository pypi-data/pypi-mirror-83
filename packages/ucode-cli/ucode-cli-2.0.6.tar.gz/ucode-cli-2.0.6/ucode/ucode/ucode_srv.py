...
if __name__ == "__main__":
    ...
    ucode = UCode("https://api.ucode.vn/api", "8bfc586633cad92f2bbe10c1389bbceb")
    # ucode = UCode("https://dev-api.ucode.vn/api", "b1f3bba4df8c50713ee39d9f75647739")

    problem = ProblemService.load("/home/thuc/projects/ucode/dsa-thematic-problems/dp/Dp_2D/knapsack_problem",
                                  load_testcase=True)
