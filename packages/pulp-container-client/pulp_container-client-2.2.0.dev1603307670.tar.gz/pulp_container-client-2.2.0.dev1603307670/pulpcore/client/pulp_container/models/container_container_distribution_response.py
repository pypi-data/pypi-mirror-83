...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, content_guard=None, base_path=None, name=None, repository_version=None, repository=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
