...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, name=None, repository_version=None, base_path=None, pulp_created=None, pulp_href=None, repository=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
