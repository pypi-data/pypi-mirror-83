...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository=None, pulp_href=None, repository_version=None, content_guard=None, name=None, base_path=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
