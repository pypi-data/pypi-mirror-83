...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, repository=None, base_path=None, content_guard=None, pulp_created=None, pulp_href=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
