...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, repository=None, name=None, base_path=None, pulp_created=None, content_guard=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
