...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, name=None, pulp_href=None, pulp_created=None, content_guard=None, repository=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
