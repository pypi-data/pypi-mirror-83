...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, name=None, repository=None, repository_version=None, content_guard=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
