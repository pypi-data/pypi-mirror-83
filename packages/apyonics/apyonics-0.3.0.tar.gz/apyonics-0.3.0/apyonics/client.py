...
class Client(object):
    ...
    def __init__(self,service_url='',username='',api_key=''):
        ...
        To use the .aionics_key file, provide no arguments.
        To ignore the .aionics_key file, provide all three arguments.
        ...
        if not service_url and not username and not api_key:
    ...
    def get_design_settings(self,design_id,settings_key=None):
        ...
        resp = self.session.get(
            ...
            data={'design_id':design_id,'settings_key':settings_key}
        )
        if resp.status_code == 200:
            return resp.json()
        else:
    ...
    def get_design_results(self,design_id,results_key=None):
        ...
        resp = self.session.get(
            ...
            data={'design_id':design_id,'results_key':results_key}
        )
        if resp.status_code == 200:
            return resp.json()
        else:
