def steal(fname,tfd):
    """
    steal function takes file name of lammps data file and steals their id and 
    postions and returns and array with all the atom types and molecule types 
    converted to 1
    """
    import numpy as np
...
def radius(n):
    ...
    #Returns radius and necessary system vol
    return r,sysVol
"""_________________________________________________________________________"""
def boundtf(fname,tfd):
    """
...
def angler(n,um,tfd):
    ...
    return angles
"""_________________________________________________________________________"""
def buildNwrite(um,filetoread,filetowrite,tfd):
    """
...
if __name__ == '__main__':
    buildNwrite(20, "data.collapse", "data.um", 200)