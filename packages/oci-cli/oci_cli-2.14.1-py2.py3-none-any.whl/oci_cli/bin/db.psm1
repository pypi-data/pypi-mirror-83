...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-container-database-dataguard autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-dataguard autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-patch autonomous-vm-cluster backup backup-destination cloud-exa-infra cloud-vm-cluster console-connection data-guard-association database database-software-image db-home exadata-infrastructure external-backup-job gi-version maintenance-run node patch patch-history system system-shape version vm-cluster vm-cluster-network'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-container-database create' = 'autonomous-exadata-infrastructure-id autonomous-vm-cluster-id backup-config compartment-id db-unique-name defined-tags display-name freeform-tags from-json help kms-key-id kms-key-version-id maintenance-window-details max-wait-seconds patch-model peer-autonomous-container-database-display-name peer-autonomous-exadata-infrastructure-id protection-mode service-level-agreement-type standby-maintenance-buffer-in-days vault-id wait-for-state wait-interval-seconds'
        ...
        'db data-guard-association create from-existing-db-system' = 'creation-type database-admin-password database-id from-json help peer-db-home-id peer-db-system-id protection-mode transport-type'
        'db data-guard-association create from-existing-vm-cluster' = 'database-admin-password database-id from-json help peer-db-home-id peer-vm-cluster-id protection-mode transport-type'
