...
class Feature(Connection):
    ...
    def get(self):
        ...
        """
        self._namespace = Namespace(**self._get(f"/features/{self.id}", api_version=1).json())
    ...
    def datasource(self):
        ...
        data_source = self._namespace.dataSource
        if data_source:
    ...
    def granularities(self):
        ...
        """
        # TODO: This is tightly coupled to the API's response object
        granularities = self._namespace.granularities
        if granularities:
    ...
    def featureSet(self):
        ...
        """
        # TODO: This is tightly coupled to the API's response object
        feature_set = self._namespace.featureSet
        if feature_set:
