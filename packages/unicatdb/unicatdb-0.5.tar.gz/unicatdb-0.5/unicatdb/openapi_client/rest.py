...
from unicatdb.openapi_client.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError
from .recursive_urlencode import deep_object_urlencode
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        try:
            ...
            if method in ['POST', 'PUT', 'PATCH', 'OPTIONS', 'DELETE']:
                if query_params:
                    url += '?' + deep_object_urlencode(query_params)
