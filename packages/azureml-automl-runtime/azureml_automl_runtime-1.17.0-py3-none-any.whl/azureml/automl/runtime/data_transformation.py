...
def _sweep_featurizers(X: DataInputType,
    ...
    with tracer.start_as_current_span(
            ...
            user_facing_name=constants.TelemetryConstants.FeaturizationStrategy
    ):
...
def build_feature_sweeped_state_container(
    ...
    allow_chargram: Optional[bool] = False
...
def _get_transformer_x(x: DataInputType,
    ...
    with tracer.start_as_current_span(
            ...
            user_facing_name=constants.TelemetryConstants.Featurization
    ):
