        ...
        for meta in result['metadatas']:
            ...
            # model_sobey_smart_face_
                ...
                for dic in meta['metadata']:
                    ...
                    cls.delete_field(dic, 'groups')
                    cls.add_or_update_field(dic, type=str(dic.get('type')), framerate=kwargs.get('frameRate'))
            ...
            # model_sobey_smart_subtitles_
                ...
                for dic in meta['metadata']:
                    cls.update_field_name(dic, **{'keyFrame': 'keyframeno', 'in': 'inpoint', 'out': 'outpoint'})
                    cls.add_or_update_field(dic, framerate=kwargs.get('frameRate'))
            ...
            # model_sobey_object_markmeta
            elif 'markmeta' in meta['type']:
                cls.add_or_update_field(meta, type='model_sobey_smart_markkeyframe_',
                                        name='model_sobey_smart_markkeyframe_')
                for dic in meta['metadata']:
                    cls.update_field_name(dic, type='description')
                    cls.add_or_update_field(dic, framerate=kwargs.get('frameRate'))
