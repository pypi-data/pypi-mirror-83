...
#
#  $ bin/test -s cpskin.demo -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src cpskin.demo.testing.CPSKIN_DEMO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/cpskin/demo/tests/robot/test_example.robot
#
