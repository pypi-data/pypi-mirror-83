...
"""
WORKLOG_CATEGORY = """
<span class="label label-success">{{ record.category.category }}</span>
"""
...
class VMWorkLogTable(BaseTable):
    ...
    class Meta(BaseTable.Meta):
        model = VMWorkLog
        fields = ('pk', 'time', 'subject', 'category', 'user', 'ticket_id', 'log_id', 'actions')
        default_columns = ('time', 'subject', 'category', 'user', 'ticket_id', 'log_id', 'actions')
