...
class FragmentedMolecule:
    ...
    def reorder_attachment_point_numbers(self):
        self.scaffold_smiles = self._transformations.add_attachment_point_numbers(self.scaffold_smiles)

    def _re_assemble(self):
        molecule = self._transformations.join_scaffolds_and_decorations(self.scaffold_smiles, self.decorations_smiles)
