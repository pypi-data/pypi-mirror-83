...
enum classes in :py:mod:`psdtoolsx.terminology` or bytes indicates what kind
of descriptor it is.
...
from psdtoolsx.psd.base import (
    BaseElement,
    BooleanElement,
    DictElement,
    IntegerElement,
...
from psdtoolsx.constants import OSType
from psdtoolsx.terminology import Klass, Enum, Event, Form, Key, Type, Unit
from psdtoolsx.validators import in_
from psdtoolsx.utils import (
    read_fmt,
    write_fmt,
    read_unicode_string,
...
class Descriptor(_DescriptorMixin):
    ...
    :py:class:`~psdtoolsx.terminology.Key` or arbitrary length `bytes`.
    Supports direct access by :py:class:`~psdtoolsx.terminology.Key`.
    ...
    .. py:attribute:: classID
        ...
        bytes in :py:class:`~psdtoolsx.terminology.Klass`
    """
...
class ObjectArray(_DescriptorMixin):
    ...
    :py:class:`~psdtoolsx.psd.descriptor.Descriptor`.
...
class Property(BaseElement):
    ...
    .. py:attribute:: keyID
        ...
        bytes in :py:class:`~psdtoolsx.terminology.Key`
    """
    name = attr.ib(default='', type=str)
...
class EnumeratedReference(BaseElement):
    ...
    .. py:attribute:: typeID
        ...
        bytes in :py:class:`~psdtoolsx.terminology.Type`

    .. py:attribute:: enum

        bytes in :py:class:`~psdtoolsx.terminology.Enum`
    """
    name = attr.ib(default='', type=str)
    classID = attr.ib(default=b'\x00\x00\x00\x00', type=bytes)
...
class Class1(Class):
    ...
    :py:class:`~psdtoolsx.psd.descriptor.Class`.
    """
    pass
...
class Reference(List):
    ...
    :py:class:`~psdtoolsx.psd.descriptor.List`.
    """
    pass
...
class Alias(RawData):
    ...
    :py:class:`~psdtoolsx.psd.descriptor.RawData`.
    """
    pass
...
class Identifier(Integer):
    ...
    :py:class:`~psdtoolsx.psd.descriptor.Integer`.
    """
    pass
...
class Index(Integer):
    """
    Index equivalent to :py:class:`~psdtoolsx.psd.descriptor.Integer`.
    """
    pass
