...
See :py:class:`~psdtoolsx.constants.Resource` to check available
resource names.
...
from psdtoolsx.version import __version__
from psdtoolsx.constants import Resource, PrintScaleStyle
...
from psdtoolsx.psd.descriptor import DescriptorBlock
...
class ImageResource(BaseElement):
    ...
    .. py:attribute:: key
        ...
        :py:class:`~psdtoolsx.constants.Resource`.
