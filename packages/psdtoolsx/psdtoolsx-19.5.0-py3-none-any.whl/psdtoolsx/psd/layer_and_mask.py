...
from psdtoolsx.psd.base import BaseElement, ListElement
from psdtoolsx.psd.tagged_blocks import TaggedBlocks, register
from psdtoolsx.compression import compress, decompress
from psdtoolsx.validators import in_, range_
...
class ChannelInfo(BaseElement):
    ...
    .. py:attribute:: id
        ...
        :py:class:`~psdtoolsx.constants.ChannelID`.
...
class LayerRecord(BaseElement):
    ...
    .. py:attribute:: blend_mode
        ...
        Blend mode key. See :py:class:`~psdtoolsx.constants.BlendMode`.
    ...
    .. py:attribute:: clipping
        ...
        :py:class:`~psdtoolsx.constants.Clipping`.
    ...
    .. py:attribute:: blending_ranges
        ...
        See :py:class:`~psdtoolsx.constants.LayerBlendingRanges`.
...
class ChannelData(BaseElement):
    ...
    .. py:attribute:: compression
        ...
        Compression type. See :py:class:`~psdtoolsx.constants.Compression`.
    ...
    def set_data(self, data, width, height, depth, version=1):
        ...
        :param compression: compression type,
            see :py:class:`~psdtoolsx.constants.Compression`.
        :param width: width.
        :param height: height.
        :param depth: bit depth of the pixel.
        :param version: psd file version.
