...
from psdtoolsx.constants import BlendMode, EffectOSType
from psdtoolsx.psd.base import BaseElement, DictElement
...
class EffectsLayer(DictElement):
    ...
    :py:class:`psdtoolsx.constants.EffectOSType` for available keys.
