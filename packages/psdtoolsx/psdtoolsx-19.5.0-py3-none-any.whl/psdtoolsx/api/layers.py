...
from psdtoolsx.constants import BlendMode, Tag
from psdtoolsx.api.effects import Effects
from psdtoolsx.api.mask import Mask
from psdtoolsx.api.shape import VectorMask, Stroke, Origination
from psdtoolsx.api.smart_object import SmartObject

from psdtoolsx.api import deprecated
...
class Layer(object):
    ...
    def blend_mode(self):
        ...
        :return: :py:class:`~psdtoolsx.constants.BlendMode`.
        """
    ...
    def mask(self):
        ...
        :return: :py:class:`~psdtoolsx.api.mask.Mask` or `None`
        """
    ...
    def vector_mask(self):
        ...
        :return: :py:class:`~psdtoolsx.api.shape.VectorMask` or `None`
        """
    ...
    def origination(self):
        ...
        See :py:mod:`psdtoolsx.api.shape`.

        :return: List of :py:class:`~psdtoolsx.api.shape.Invalidated`,
            :py:class:`~psdtoolsx.api.shape.Rectangle`,
            :py:class:`~psdtoolsx.api.shape.RoundedRectangle`,
            :py:class:`~psdtoolsx.api.shape.Ellipse`, or
            :py:class:`~psdtoolsx.api.shape.Line`.
        """
    ...
    def topil(self, channel=None, apply_icc=False):
        ...
        :param channel: Which channel to return; e.g., 0 for 'R' channel in RGB
            image. See :py:class:`~psdtoolsx.constants.ChannelID`. When `None`,
    ...
    def compose(self, force=False, bbox=None, layer_filter=None):
        ...
        """
        from psdtoolsx.composer import compose, compose_layer
    ...
    def composite(
        ...
        """
        from psdtoolsx.composite import composite_pil
    ...
    def effects(self):
        ...
        :return: :py:class:`~psdtoolsx.api.effects.Effects`
        """
    ...
    def tagged_blocks(self):
        ...
        See :py:class:`psdtoolsx.constants.Tag` for available
        keys.

        :return: :py:class:`~psdtoolsx.psd.tagged_blocks.TaggedBlocks` or
            `None`.
...
class GroupMixin(object):
    ...
    def compose(
        ...
        """
        from psdtoolsx.composer import compose
        return compose(
            self,
            force=force,
            context=context,
...
class SmartObjectLayer(Layer):
    ...
    Use :py:attr:`~psdtoolsx.api.layers.SmartObjectLayer.smart_object`
    attribute to get the external data. See
    :py:class:`~psdtoolsx.api.smart_object.SmartObject`.
    ...
    def smart_object(self):
        ...
        :return: :py:class:`~psdtoolsx.api.smart_object.SmartObject`.
        """
...
class TypeLayer(Layer):
    ...
    Text is accessible at :py:attr:`~psdtoolsx.api.layers.TypeLayer.text`
    property. Styling information for paragraphs is in
    :py:attr:`~psdtoolsx.api.layers.TypeLayer.engine_dict`.
    Document styling information such as font list is is
    :py:attr:`~psdtoolsx.api.layers.TypeLayer.resource_dict`.
