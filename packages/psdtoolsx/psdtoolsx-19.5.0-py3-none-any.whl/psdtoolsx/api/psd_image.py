...
from psdtoolsx.constants import (
    Clipping, Compression, ColorMode, SectionDivider, Resource, Tag
)
from psdtoolsx.psd import PSD, FileHeader, ImageData, ImageResources
from psdtoolsx.api.layers import (
    Artboard, Group, PixelLayer, ShapeLayer, SmartObjectLayer, TypeLayer,
    GroupMixin
)
from psdtoolsx.api import adjustments
...
class PSDImage(GroupMixin):
    ...
    def new(cls, mode, size, color=0, depth=8, **kwargs):
        ...
        :return: A :py:class:`~psdtoolsx.api.psd_image.PSDImage` object.
        """
    ...
    def frompil(cls, image, compression=Compression.RLE):
        ...
        :param compression: ImageData compression option. See
            :py:class:`~psdtoolsx.constants.Compression`.
        :return: A :py:class:`~psdtoolsx.api.psd_image.PSDImage` object.
        """
    ...
    def bbox(self):
        ...
        Use :py:attr:`~psdtoolsx.api.psd_image.PSDImage.viewbox` to get
    ...
    def color_mode(self):
        ...
        :py:class:`~psdtoolsx.constants.ColorMode`.

        :return: :py:class:`~psdtoolsx.constants.ColorMode`
        """
    ...
    def image_resources(self):
        ...
        :py:class:`~psdtoolsx.psd.image_resources.ImageResources` is a
        dict-like structure that keeps various document settings.

        See :py:class:`psdtoolsx.constants.Resource` for available keys.

        :return: :py:class:`~psdtoolsx.psd.image_resources.ImageResources`
