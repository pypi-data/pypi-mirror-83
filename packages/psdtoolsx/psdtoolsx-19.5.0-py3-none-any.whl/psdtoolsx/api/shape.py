...
from psdtoolsx.psd.vector import Subpath, InitialFillRule, ClipboardRecord
...
class VectorMask(object):
    ...
    Bezier curves. Check :py:attr:`~psdtoolsx.api.shape.VectorMask.paths`
    ...
    def paths(self):
        """
        List of :py:class:`~psdtoolsx.psd.vector.Subpath`. Subpath is a
        list-like structure that contains one or more
        :py:class:`~psdtoolsx.psd.vector.Knot` items. Knot contains
        relative coordinates of control points for a Bezier curve.
        :py:attr:`~psdtoolsx.psd.vector.Subpath.index` indicates which
        origination item the subpath belongs, and
        :py:class:`~psdtoolsx.psd.vector.Subpath.operation` indicates how
...
class Stroke(object):
    ...
    :py:class:`~psdtoolsx.psd.descriptor.Descriptor` structure.
    ...
    def line_dash_set(self):
        ...
        :py:class:`~psdtoolsx.decoder.actions.UnitFloat`.
...
class Origination(object):
    ...
    def origin_type(self):
        ...
        * 1: :py:class:`~psdtoolsx.api.shape.Rectangle`
        * 2: :py:class:`~psdtoolsx.api.shape.RoundedRectangle`
        * 4: :py:class:`~psdtoolsx.api.shape.Line`
        * 5: :py:class:`~psdtoolsx.api.shape.Ellipse`
    ...
    def bbox(self):
        ...
        :return: :py:class:`~psdtoolsx.psd.descriptor.Descriptor`
        """
...
class Invalidated(Origination):
    ...
    properties. Use :py:class:`~psdtoolsx.api.shape.VectorMask` to access
