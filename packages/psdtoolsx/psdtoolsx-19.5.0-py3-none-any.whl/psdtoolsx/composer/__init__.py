...
from psdtoolsx.constants import Tag, BlendMode
from psdtoolsx.api.pil_io import get_pil_mode
from psdtoolsx.api.layers import Group
from psdtoolsx.composer.blend import blend
from psdtoolsx.composer.effects import create_stroke_effect
from psdtoolsx.composer.vector import (
    draw_pattern_fill, draw_gradient_fill, draw_solid_color_fill,
    draw_vector_mask, draw_stroke
)
from psdtoolsx.terminology import Enum, Key
...
def apply_mask(layer, image, bbox=None):
    ...
    :param layer: `~psdtoolsx.api.layers.Layer`
