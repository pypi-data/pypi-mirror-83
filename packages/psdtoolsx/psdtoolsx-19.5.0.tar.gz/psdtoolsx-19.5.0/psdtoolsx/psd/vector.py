...
from psdtoolsx.psd.base import BaseElement, ListElement, ValueElement
from psdtoolsx.constants import PathResourceID
from psdtoolsx.psd.descriptor import Descriptor
...
class VectorMaskSetting(BaseElement):
    ...
    .. py:attribute:: path
        ...
        List of :py:class:`~psdtoolsx.psd.vector.Subpath` objects.
    """
