...
from psdtoolsx.constants import Compression
from psdtoolsx.psd.base import BaseElement
from psdtoolsx.validators import in_
from psdtoolsx.utils import read_fmt, write_fmt, write_bytes, pack
...
class ImageData(BaseElement):
    ...
    def get_data(self, header, split=True):
        ...
        :param header: See :py:class:`~psdtoolsx.psd.header.FileHeader`.
