...
That means, all the data structures in the :py:mod:`psdtoolsx.psd` subpackage
implements the methods of :py:class:`~psdtoolsx.psd.BaseElement` for
serialization and decoding.

Objects that inherit from the :py:class:`~psdtoolsx.psd.BaseElement` typically
...
class BaseElement(object):
    ...
    :py:mod:`psdtoolsx.psd` subpackage inherit from this class.
