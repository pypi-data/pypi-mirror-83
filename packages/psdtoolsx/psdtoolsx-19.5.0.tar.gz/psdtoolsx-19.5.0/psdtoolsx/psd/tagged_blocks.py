...
from psdtoolsx.psd.adjustments import ADJUSTMENT_TYPES
...
from psdtoolsx.psd.color import Color
from psdtoolsx.psd.descriptor import DescriptorBlock, DescriptorBlock2
from psdtoolsx.psd.effects_layer import EffectsLayer
from psdtoolsx.psd.engine_data import EngineData, EngineData2
from psdtoolsx.psd.filter_effects import FilterEffects
from psdtoolsx.psd.linked_layer import LinkedLayers
from psdtoolsx.psd.patterns import Patterns
from psdtoolsx.psd.vector import (
...
class TaggedBlocks(DictElement):
    ...
    See :py:class:`~psdtoolsx.constants.Tag` for available keys.
...
class TaggedBlock(BaseElement):
    ...
    .. py:attribute:: key
        ...
        4-character code. See :py:class:`~psdtoolsx.constants.Tag`
