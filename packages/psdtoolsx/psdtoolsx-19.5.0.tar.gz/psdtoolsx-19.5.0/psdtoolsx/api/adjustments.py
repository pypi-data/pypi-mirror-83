...
from psdtoolsx.api.layers import AdjustmentLayer, FillLayer
from psdtoolsx.constants import Tag
from psdtoolsx.utils import new_registry
...
class Curves(AdjustmentLayer):
    ...
    def data(self):
        ...
        :return: :py:class:`~psdtoolsx.psd.adjustments.Curves`
        """
        return self._data
...
class Levels(AdjustmentLayer):
    ...
    :py:class:`~psdtoolsx.psd.adjustments.LevelRecord`.
    """
    ...
    def data(self):
        ...
        :return: :py:class:`~psdtoolsx.psd.adjustments.Levels`.
        """
        return self._data
