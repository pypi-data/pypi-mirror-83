import numpy as np
from psdtoolsx.constants import Tag, BlendMode, ColorMode
from psdtoolsx.api.layers import AdjustmentLayer, Layer
from psdtoolsx.api.numpy_io import EXPECTED_CHANNELS
...
def composite_pil(
    ...
    from psdtoolsx.api.numpy_io import has_transparency
