...
class Test(unittest.TestCase):
  ...
  def testCreateDeltasAVG(self):
    ...
    dlt = gt.getDeltas()
    t = sorted(dlt.deltaSet.values(), key=lambda p:p.noPt)
    self.assertEquals(16, len(t))

    self.assertEquals(10074, t[0].noPt)
    self.assertEquals(Vector3d(0.0, 0.04999995, 0.0), t[0])
    self.assertEquals(10076, t[2].noPt)
    self.assertEquals(Vector3d(0.0, 0.15, 0.0), t[2])
    ...
    dlt = gt.getDeltas()
    t = sorted(dlt.deltaSet.values(), key=lambda p:p.noPt)
    self.assertEquals(28, len(t))
    self.assertEquals(10073, t[9].noPt)
    ...
    self.assertEquals(10074, t[10].noPt)
    ...
    self.assertEquals(10076, t[12].noPt)
