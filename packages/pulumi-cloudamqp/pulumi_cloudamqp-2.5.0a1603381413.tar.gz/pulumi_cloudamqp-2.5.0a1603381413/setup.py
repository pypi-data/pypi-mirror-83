...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '2.5.0-alpha.1603381413+680d00e1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 2.5.0-alpha.1603381413+680d00e1`
                """)
            else:
                raise
