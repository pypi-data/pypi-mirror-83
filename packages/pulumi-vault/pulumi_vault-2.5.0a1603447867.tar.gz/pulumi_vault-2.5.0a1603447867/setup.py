...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.5.0-alpha.1603447867+ead0e05b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.5.0-alpha.1603447867+ead0e05b`
                """)
            else:
                raise
