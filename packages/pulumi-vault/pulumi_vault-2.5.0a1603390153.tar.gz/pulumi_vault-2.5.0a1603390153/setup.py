...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.5.0-alpha.1603390153+bbc5c7bd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.5.0-alpha.1603390153+bbc5c7bd`
                """)
            else:
                raise
