...
encryption = Encryption(key="test/testkey1",passphrase="test1")
encryption.generate_keys()
encryption.load_keys()
print(encryption.encrypt_directory("test/mytestdir", recursive=True, layers=3))
print(encryption.decrypt_directory("test/mytestdir", recursive=True, layers=3))
quit()
