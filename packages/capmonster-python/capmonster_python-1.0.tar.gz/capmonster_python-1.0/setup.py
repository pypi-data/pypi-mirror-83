...
setup(
  ...
  download_url="https://github.com/alperensert/python_capmonster/archive/v1.0.tar.gz",
  keywords=["RECAPTCHA", "CAPMONSTER", "RECAPTCHAV2", "RECAPTCHAV3", "IMAGETOTEXT", "CAPTCHA"],
