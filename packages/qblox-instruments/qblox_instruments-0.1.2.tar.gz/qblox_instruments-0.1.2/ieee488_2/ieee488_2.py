...
class ieee488_2:
    ...
    def __init__(self, tp: transport) -> None:
        """
        Constructor
        """
        self._transport = tp
    ...
    ##########################################################################
    def _bin_block_write(self, bin_block: bytes, cmd_str: str) -> None:
        """
    ...
    def _write_bin(self, cmd_str: str, args) -> None:
        self._bin_block_write(args, cmd_str + " ")
