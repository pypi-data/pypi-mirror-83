    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.3.0 fwBuild=24/09/2020-11:54:00 fwHash=0x63A11F93 fwDirty=0 kmodVersion=0.3.0 kmodBuild=24/09/2020-11:54:00 kmodHash=0x63A11F93 kmodDirty=0 swVersion=0.3.0 swBuild=24/09/2020-11:54:00 swHash=0x63A11F93 swDirty=0"
                if build != build_ref:
