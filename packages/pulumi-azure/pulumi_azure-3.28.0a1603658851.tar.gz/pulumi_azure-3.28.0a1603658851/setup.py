...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.28.0-alpha.1603658851+c1bee646'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.28.0-alpha.1603658851+c1bee646`
                """)
            else:
                raise
