...
class Iface(object):
    ...
    def fieldAutoSuggest(self, auth, query, field, limit, dataSetIds):
        """
        Parameters:
         - auth
         - query
...
class Client(Iface):
    ...
    def fieldAutoSuggest(self, auth, query, field, limit, dataSetIds):
        ...
        Parameters:
         ...
         - dataSetIds
        """
        self.send_fieldAutoSuggest(auth, query, field, limit, dataSetIds)
        return self.recv_fieldAutoSuggest()

    def send_fieldAutoSuggest(self, auth, query, field, limit, dataSetIds):
...
class Processor(Iface, TProcessor):
    ...
    def process_fieldAutoSuggest(self, seqid, iprot, oprot):
        ...
        result = fieldAutoSuggest_result()
        try:
            result.success = self._handler.fieldAutoSuggest(args.auth, args.query, args.field, args.limit, args.dataSetIds)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except koverse.thriftgen.ttypes.TKoverseException as ke:
...
class fieldAutoSuggest_args(object):
    ...
    def __init__(self, auth=None, query=None, field=None, limit=None, dataSetIds=None,):
        self.auth = auth
        self.query = query
        self.field = field
        self.limit = limit
