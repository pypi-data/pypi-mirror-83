...
#
#  $ bin/test -s cpskin.cirkwi -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src cpskin.cirkwi.testing.CPSKIN_CIRKWI_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/cpskin/cirkwi/tests/robot/test_example.robot
#
