...
def test_global_type_consistency_check_with_critique():
    ...
    result = _typing.global_type_consistency_check(catalog)
...
def test_global_type_consistency_check_without_critique():
