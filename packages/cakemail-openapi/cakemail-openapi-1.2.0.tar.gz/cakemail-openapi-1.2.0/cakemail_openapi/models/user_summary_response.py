...
class UserSummaryResponse(object):
    ...
    def __init__(self, id=None, email=None, status=None, first_name=None, last_name=None, last_activity_on=None, expires_on=None, local_vars_configuration=None):  # noqa: E501
