...
class AccountOwnerUser(object):
    ...
    def office_phone(self, office_phone):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                office_phone is not None and len(office_phone) < 1):
            raise ValueError("Invalid value for `office_phone`, length must be greater than or equal to `1`")  # noqa: E501
    ...
    def mobile_phone(self, mobile_phone):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                mobile_phone is not None and len(mobile_phone) < 10):
            raise ValueError("Invalid value for `mobile_phone`, length must be greater than or equal to `10`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
