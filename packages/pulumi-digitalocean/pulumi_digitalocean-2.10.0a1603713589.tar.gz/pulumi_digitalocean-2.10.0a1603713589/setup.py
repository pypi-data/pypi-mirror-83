...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.10.0-alpha.1603713589+de9ae031'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.10.0-alpha.1603713589+de9ae031`
                """)
            else:
                raise
