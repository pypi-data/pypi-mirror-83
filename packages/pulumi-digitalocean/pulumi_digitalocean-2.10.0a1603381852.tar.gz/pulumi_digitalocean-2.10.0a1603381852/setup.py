...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.10.0-alpha.1603381852+a2c42c0f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.10.0-alpha.1603381852+a2c42c0f`
                """)
            else:
                raise
