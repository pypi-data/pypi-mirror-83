...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.26.0-alpha.1603658913+6133810e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.26.0-alpha.1603658913+6133810e`
                """)
            else:
                raise
