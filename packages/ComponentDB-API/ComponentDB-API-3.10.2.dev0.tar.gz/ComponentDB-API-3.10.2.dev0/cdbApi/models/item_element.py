...
class ItemElement(object):
    ...
    def __init__(self, id=None, name=None, is_required=None, description=None, sort_order=None, list_list=None, property_value_list=None, log_list=None, derived_from_item_element_list=None, derived_from_item_element=None, item_element_history_list=None, row_style=None, import_child_item=None, parent_item_id=None, contained_item1_id=None, contained_item2_id=None, local_vars_configuration=None):  # noqa: E501
