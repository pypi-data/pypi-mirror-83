...
class ItemDomainMachineDesign(object):
    ...
    def __init__(self, id=None, name=None, item_identifier1=None, item_identifier2=None, qr_id=None, domain=None, derived_from_item=None, item_source_list=None, is_cloned=None, current_hierarchy_item_element=None, assigned_item=None, status_property_type_name=None, import_child_parent_relationship=None, alternate_name=None, primary_image_for_item=None, description=None, entity_type_list=None, item_category_list=None, item_type_list=None, item_project_list=None, local_vars_configuration=None):  # noqa: E501
