...
- Failing to send print statements to output, depending on how PsychoPy was launched `commit:4773ec32d <https://github.com/psychopy/psychopy/commit/4773ec32dcf>`_ Only occured if you launch by double-clicking file or if you close Runner
