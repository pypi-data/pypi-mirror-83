...
try:
    ...
    pass
# asyncio._get_running_loop is available only after Python 3.5.2
if sys.version_info >= (3, 7):
    try:
        ...
        curr_id = contextvars.ContextVar('curr_context')
        ...
        def _get_state():
            ...
            return hash(id(_state if task is None else task))
        curr_id.set(_get_state())
        get_ident = lambda: hash(curr_id.get(None))
        set_ident = lambda: curr_id.set(_get_state())
    except ImportError:
        pass
