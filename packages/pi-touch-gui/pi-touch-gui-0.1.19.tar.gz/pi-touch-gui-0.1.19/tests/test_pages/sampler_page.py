...
from widget_buttons import Button, ButtonGroup, GraphButton
from widget_controls import Dial, Slider
from widget_displays import Indicator, Label
...
def sampler_page():
    ...
    _control_graph = GraphButton((410, 130), (390, 100),
                                 label_color1=BLACK, label='Ctrl',
                                 update=_graph_button_update)
    ...
    _fake_graph = GraphButton((680, 240), (110, 150), quiet=True,
                              update=fake_data_graph_function)
    ...
    _sampler_page = Page(
        ...
        [
            _up_button, _up_dn_indicator, _dn_button,
