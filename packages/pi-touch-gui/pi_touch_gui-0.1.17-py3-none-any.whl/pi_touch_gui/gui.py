...
from _widget_bases import IWidget, IWidgetInterface
from colors import BLACK
from multitouch.raspberrypi_ts import Touchscreen, TS_RELEASE
...
class GUI(object):
    ...
    def run(self, page) -> NoReturn:
        ...
        try:
            ...
            backlog_error(e, f"Unmanaged exception")
        finally:
            self.reset_display()
