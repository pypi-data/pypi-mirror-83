...
class Trip(object):
    ...
    def __init__(self, key=None, assigned_shifts=None, actions=None, waitlist=None, start_location_key=None, finish_location_key=None, local_vars_configuration=None):  # noqa: E501
