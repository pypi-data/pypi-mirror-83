...
class TimeMachinePT(object):
    ...
    def to(self, craft, ckpt_scope=None, frozen=False, ins=None, outs=None):
    ...
    def drop(self, craft, save_scope=None, frozen=False, anchor=None):
        ...
        if self.param['save_path'] is None:
            ...
            save_ckpt = os.path.join(self.param['save_path'], '%s-%d.pth'%(craft.scope, self.counter))
