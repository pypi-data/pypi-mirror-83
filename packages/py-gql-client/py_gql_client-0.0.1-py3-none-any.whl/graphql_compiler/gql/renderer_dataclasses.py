...
class DataclassesRenderer:
    ...
    def render(self, parsed_query: ParsedQuery) -> str:
        ...
        buffer.write("from gql.datetime_utils import DATETIME_FIELD")
        buffer.write("from gql.graphql_client import GraphqlClient")
        buffer.write("from gql.client import OperationException")
        buffer.write("from gql.reporter import FailedOperationException")
        ...
        if enum_names:
            buffer.write("from gql.enum_utils import enum_field")
