...
'''
    ...
    Requires the logit package available on PyPI.

    Copyright 2008-2020 DeNova
    Last modified: 2020-10-24

    Documentation at https://denova.com/open_source/logit/
...
basic_logging_file = tempfile.NamedTemporaryFile(
    mode='a',
    prefix='/tmp/denova.python.default.',
    suffix='.log',
    delete=True)
...
class _Log():
    ...
    def _write_log_entry(self, log_entry):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
            ...
            try:
                sock.connect((LOG_SERVER_HOST, LOG_SERVER_PORT))

            except ConnectionRefusedError:
                try:
                    msg = f'No log server at {LOG_SERVER_HOST}:{LOG_SERVER_PORT}'
