...
class UNUSED_TitleNode(Node):
    ...
    def render(self, context):
        ...
        return '''
            ...
            ''' % {'text': self.text}
        """
        START_BLOCK_TITLE = '{%% block title %%}'
        END_BLOCK_TITLE = '{%% endblock %%}'
        START_BLOCK_TITLEVAR = '{%% block titlevar %%}'
        END_BLOCK_TITLEVAR = '{%% endblock %%}'
        START_HEADLINE = '{%% block headline %%}'
        END_HEADLINE = '{%% endblock %%}'

        context['title'] = self.text
        title_line = f'{START_BLOCK_TITLE}{self.text}{END_BLOCK_TITLE}'
        titlevar_line = f'{START_BLOCK_TITLEVAR}{self.text}{END_BLOCK_TITLEVAR}'
        head_line = f'{START_HEADLINE}{self.text}{END_HEADLINE}'
        return f'{title_line}\n{titlevar_line}\n{head_line}\n'
