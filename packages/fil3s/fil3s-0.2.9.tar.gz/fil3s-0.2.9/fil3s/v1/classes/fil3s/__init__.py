...
class Files():
    ...
    class Directory(object):
        ...
        def generate_path(self, characters=24, extension="/"):
            path, paths = None, self.paths()
            for x in range(1000):
                path = self.join(utils.generate.shell_string(characters=characters), extension)
...
class Formats():
    ...
    class String(object):
        ...
        def capitalized_scentence(self):
            ...
            return " ".join(cap)
        def generate(self, characters=6):
            return generate.shell_string(characters=characters)
            #
    ...
    class Integer(object):
        ...
        def generate(self, characters=6):
            return generate.pincode(characters=characters)
            #
